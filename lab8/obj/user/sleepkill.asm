...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 80 18 80 00 	movl   $0x801880,(%esp)
  ...
  800284:	c7 04 24 8b 18 80 00 	movl   $0x80188b,(%esp)
  ...
  80029a:	c7 04 24 9d 18 80 00 	movl   $0x80189d,(%esp)
  ...
  8002b0:	c7 04 24 b0 18 80 00 	movl   $0x8018b0,(%esp)
  ...
  8002c6:	c7 04 24 c3 18 80 00 	movl   $0x8018c3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 d6 18 80 00 	movl   $0x8018d6,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 f0 18 80 00 	movl   $0x8018f0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 f2 18 80 00 	movl   $0x8018f2,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 f0 18 80 00 	movl   $0x8018f0,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 0e 19 80 00 	movl   $0x80190e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 21 19 80 	movl   $0x801921,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 28 19 80 	movl   $0x801928,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 42 19 80 00 	movl   $0x801942,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 54 19 80 	movl   $0x801954,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 5c 19 80 	movl   $0x80195c,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 42 19 80 00 	movl   $0x801942,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 84 1b 80 00       	add    $0x801b84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 a8 1b 80 00 	mov    0x801ba8(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c 9e 1b 80 	movl   $0x801b9e,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be a1 1b 80 00       	mov    $0x801ba1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017d9:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8017dd:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8017e2:	75 18                	jne    8017fc <main+0x31>
        sleep(~0);
  8017e4:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8017eb:	e8 81 f1 ff ff       	call   800971 <sleep>
        exit(0xdead);
  8017f0:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  8017f7:	e8 c6 f0 ff ff       	call   8008c2 <exit>
    }
    assert(pid > 0);
  8017fc:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801801:	7f 24                	jg     801827 <main+0x5c>
  801803:	c7 44 24 0c 00 1d 80 	movl   $0x801d00,0xc(%esp)
  80180a:	00 
  80180b:	c7 44 24 08 08 1d 80 	movl   $0x801d08,0x8(%esp)
  801812:	00 
  801813:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  80181a:	00 
  80181b:	c7 04 24 1d 1d 80 00 	movl   $0x801d1d,(%esp)
  801822:	e8 c5 ea ff ff       	call   8002ec <__panic>

    sleep(100);
  801827:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  80182e:	e8 3e f1 ff ff       	call   800971 <sleep>
    assert(kill(pid) == 0);
  801833:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801837:	89 04 24             	mov    %eax,(%esp)
  80183a:	e8 f2 f0 ff ff       	call   800931 <kill>
  80183f:	85 c0                	test   %eax,%eax
  801841:	74 24                	je     801867 <main+0x9c>
  801843:	c7 44 24 0c 2e 1d 80 	movl   $0x801d2e,0xc(%esp)
  80184a:	00 
  80184b:	c7 44 24 08 08 1d 80 	movl   $0x801d08,0x8(%esp)
  801852:	00 
  801853:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80185a:	00 
  80185b:	c7 04 24 1d 1d 80 00 	movl   $0x801d1d,(%esp)
  801862:	e8 85 ea ff ff       	call   8002ec <__panic>
    cprintf("sleepkill pass.\n");
  801867:	c7 04 24 3d 1d 80 00 	movl   $0x801d3d,(%esp)
  80186e:	e8 6a eb ff ff       	call   8003dd <cprintf>
    return 0;
