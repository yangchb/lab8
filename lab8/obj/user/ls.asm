...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 80 1b 80 00 	movl   $0x801b80,(%esp)
  ...
  800284:	c7 04 24 8b 1b 80 00 	movl   $0x801b8b,(%esp)
  ...
  80029a:	c7 04 24 9d 1b 80 00 	movl   $0x801b9d,(%esp)
  ...
  8002b0:	c7 04 24 b0 1b 80 00 	movl   $0x801bb0,(%esp)
  ...
  8002c6:	c7 04 24 c3 1b 80 00 	movl   $0x801bc3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 d6 1b 80 00 	movl   $0x801bd6,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 f0 1b 80 00 	movl   $0x801bf0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 f2 1b 80 00 	movl   $0x801bf2,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 f0 1b 80 00 	movl   $0x801bf0,(%esp)
...
lock_fork(void) {
  ...
  80089d:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  8008a0:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
unlock_fork(void) {
  ...
  8008b1:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  8008b4:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 0e 1c 80 00 	movl   $0x801c0e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 21 1c 80 	movl   $0x801c21,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 28 1c 80 	movl   $0x801c28,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 42 1c 80 00 	movl   $0x801c42,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 54 1c 80 	movl   $0x801c54,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 5c 1c 80 	movl   $0x801c5c,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 42 1c 80 00 	movl   $0x801c42,(%esp)
  ...
  800ad5:	e8 37 10 00 00       	call   801b11 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 84 1e 80 00       	add    $0x801e84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 a8 1e 80 00 	mov    0x801ea8(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c 9e 1e 80 	movl   $0x801e9e,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be a1 1e 80 00       	mov    $0x801ea1,%esi
            }
            if (width > 0 && padc != '-') {
...
getmode(uint32_t st_mode) {
  ...
  8017ce:	83 ec 10             	sub    $0x10,%esp
    char mode = '?';
  8017d1:	c6 45 ff 3f          	movb   $0x3f,-0x1(%ebp)
    if (S_ISREG(st_mode)) mode = '-';
  8017d5:	8b 45 08             	mov    0x8(%ebp),%eax
  8017d8:	25 00 70 00 00       	and    $0x7000,%eax
  8017dd:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8017e2:	75 04                	jne    8017e8 <getmode+0x1d>
  8017e4:	c6 45 ff 2d          	movb   $0x2d,-0x1(%ebp)
    if (S_ISDIR(st_mode)) mode = 'd';
  8017e8:	8b 45 08             	mov    0x8(%ebp),%eax
  8017eb:	25 00 70 00 00       	and    $0x7000,%eax
  8017f0:	3d 00 20 00 00       	cmp    $0x2000,%eax
  8017f5:	75 04                	jne    8017fb <getmode+0x30>
  8017f7:	c6 45 ff 64          	movb   $0x64,-0x1(%ebp)
    if (S_ISLNK(st_mode)) mode = 'l';
  8017fb:	8b 45 08             	mov    0x8(%ebp),%eax
  8017fe:	25 00 70 00 00       	and    $0x7000,%eax
  801803:	3d 00 30 00 00       	cmp    $0x3000,%eax
  801808:	75 04                	jne    80180e <getmode+0x43>
  80180a:	c6 45 ff 6c          	movb   $0x6c,-0x1(%ebp)
    if (S_ISCHR(st_mode)) mode = 'c';
  80180e:	8b 45 08             	mov    0x8(%ebp),%eax
  801811:	25 00 70 00 00       	and    $0x7000,%eax
  801816:	3d 00 40 00 00       	cmp    $0x4000,%eax
  80181b:	75 04                	jne    801821 <getmode+0x56>
  80181d:	c6 45 ff 63          	movb   $0x63,-0x1(%ebp)
    if (S_ISBLK(st_mode)) mode = 'b';
  801821:	8b 45 08             	mov    0x8(%ebp),%eax
  801824:	25 00 70 00 00       	and    $0x7000,%eax
  801829:	3d 00 50 00 00       	cmp    $0x5000,%eax
  80182e:	75 04                	jne    801834 <getmode+0x69>
  801830:	c6 45 ff 62          	movb   $0x62,-0x1(%ebp)
    return mode;
  801834:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
  801838:	c9                   	leave  
  801839:	c3                   	ret    
...
getstat(const char *name, struct stat *stat) {
  ...
  801840:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801847:	00 
  801848:	8b 45 08             	mov    0x8(%ebp),%eax
  80184b:	89 04 24             	mov    %eax,(%esp)
  80184e:	e8 a5 e8 ff ff       	call   8000f8 <open>
  801853:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801856:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  80185a:	79 05                	jns    801861 <getstat+0x27>
        return fd;
  80185c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80185f:	eb 23                	jmp    801884 <getstat+0x4a>
    }
    ret = fstat(fd, stat);
...
lsstat(struct stat *stat, const char *filename) {
  ...
  801894:	e8 32 ff ff ff       	call   8017cb <getmode>
  801899:	0f be c0             	movsbl %al,%eax
  80189c:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018a0:	c7 44 24 04 00 20 80 	movl   $0x802000,0x4(%esp)
  8018a7:	00 
  8018a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018af:	e8 0d ec ff ff       	call   8004c1 <fprintf>
    printf(" %3d(h)", stat->st_nlinks);
  8018b4:	8b 45 08             	mov    0x8(%ebp),%eax
  8018b7:	8b 40 04             	mov    0x4(%eax),%eax
  8018ba:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018be:	c7 44 24 04 08 20 80 	movl   $0x802008,0x4(%esp)
  8018c5:	00 
  8018c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018cd:	e8 ef eb ff ff       	call   8004c1 <fprintf>
    printf(" %8d(b)", stat->st_blocks);
  8018d2:	8b 45 08             	mov    0x8(%ebp),%eax
  8018d5:	8b 40 08             	mov    0x8(%eax),%eax
  8018d8:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018dc:	c7 44 24 04 10 20 80 	movl   $0x802010,0x4(%esp)
  8018e3:	00 
  8018e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018eb:	e8 d1 eb ff ff       	call   8004c1 <fprintf>
    printf(" %8d(s)", stat->st_size);
  8018f0:	8b 45 08             	mov    0x8(%ebp),%eax
  8018f3:	8b 40 0c             	mov    0xc(%eax),%eax
  8018f6:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018fa:	c7 44 24 04 18 20 80 	movl   $0x802018,0x4(%esp)
  801901:	00 
  801902:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801909:	e8 b3 eb ff ff       	call   8004c1 <fprintf>
    printf("   %s\n", filename);
  80190e:	8b 45 0c             	mov    0xc(%ebp),%eax
  801911:	89 44 24 08          	mov    %eax,0x8(%esp)
  801915:	c7 44 24 04 20 20 80 	movl   $0x802020,0x4(%esp)
  80191c:	00 
  80191d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801924:	e8 98 eb ff ff       	call   8004c1 <fprintf>
}
  801929:	c9                   	leave  
  80192a:	c3                   	ret    
...
lsdir(const char *path) {
  ...
  80192e:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  801931:	8d 45 d8             	lea    -0x28(%ebp),%eax
  801934:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int ret;
    DIR *dirp = opendir(".");
  801937:	c7 04 24 27 20 80 00 	movl   $0x802027,(%esp)
  80193e:	e8 dd e6 ff ff       	call   800020 <opendir>
  801943:	89 45 f0             	mov    %eax,-0x10(%ebp)
    
    if (dirp == NULL) {
  801946:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80194a:	75 07                	jne    801953 <lsdir+0x28>
        return -1;
  80194c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801951:	eb 7e                	jmp    8019d1 <lsdir+0xa6>
    }
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
  801953:	eb 44                	jmp    801999 <lsdir+0x6e>
  ...
  801965:	e8 d0 fe ff ff       	call   80183a <getstat>
  80196a:	89 45 e8             	mov    %eax,-0x18(%ebp)
  80196d:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  801971:	74 11                	je     801984 <lsdir+0x59>
            goto failed;
  801973:	90                   	nop
    }
    printf("lsdir: step 4\n");
...
failed:
  ...
  80197a:	e8 4a e7 ff ff       	call   8000c9 <closedir>
    return ret;
  80197f:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801982:	eb 4d                	jmp    8019d1 <lsdir+0xa6>
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
  ...
  801994:	e8 ed fe ff ff       	call   801886 <lsstat>
  ...
  80199f:	e8 f5 e6 ff ff       	call   800099 <readdir>
  8019a4:	89 45 ec             	mov    %eax,-0x14(%ebp)
  8019a7:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8019ab:	75 a8                	jne    801955 <lsdir+0x2a>
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
        }
        lsstat(stat, direntp->name);
    ...
    printf("lsdir: step 4\n");
  8019ad:	c7 44 24 04 29 20 80 	movl   $0x802029,0x4(%esp)
  8019b4:	00 
  8019b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8019bc:	e8 00 eb ff ff       	call   8004c1 <fprintf>
    closedir(dirp);
  8019c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8019c4:	89 04 24             	mov    %eax,(%esp)
  8019c7:	e8 fd e6 ff ff       	call   8000c9 <closedir>
    return 0;
...
ls(const char *path) {
  ...
  8019d6:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  8019d9:	8d 45 dc             	lea    -0x24(%ebp),%eax
  ...
  8019ec:	e8 49 fe ff ff       	call   80183a <getstat>
  8019f1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  8019f4:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8019f8:	74 08                	je     801a02 <ls+0x2f>
        return ret;
  8019fa:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019fd:	e9 0d 01 00 00       	jmp    801b0f <ls+0x13c>
        " [ symlink ]",
        " [character]",
        " [  block  ]",
        " [  ?????  ]",
  ...
  801a0a:	e8 bc fd ff ff       	call   8017cb <getmode>
  801a0f:	0f be c0             	movsbl %al,%eax
  801a12:	83 f8 63             	cmp    $0x63,%eax
  801a15:	74 38                	je     801a4f <ls+0x7c>
  801a17:	83 f8 63             	cmp    $0x63,%eax
  801a1a:	7f 0c                	jg     801a28 <ls+0x55>
  801a1c:	83 f8 30             	cmp    $0x30,%eax
  801a1f:	74 13                	je     801a34 <ls+0x61>
  801a21:	83 f8 62             	cmp    $0x62,%eax
  801a24:	74 32                	je     801a58 <ls+0x85>
  801a26:	eb 39                	jmp    801a61 <ls+0x8e>
  801a28:	83 f8 64             	cmp    $0x64,%eax
  801a2b:	74 10                	je     801a3d <ls+0x6a>
  801a2d:	83 f8 6c             	cmp    $0x6c,%eax
  801a30:	74 14                	je     801a46 <ls+0x73>
  801a32:	eb 2d                	jmp    801a61 <ls+0x8e>
    case '0': type = 0; break;
  801a34:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801a3b:	eb 2c                	jmp    801a69 <ls+0x96>
    case 'd': type = 1; break;
  801a3d:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801a44:	eb 23                	jmp    801a69 <ls+0x96>
    case 'l': type = 2; break;
  801a46:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%ebp)
  801a4d:	eb 1a                	jmp    801a69 <ls+0x96>
    case 'c': type = 3; break;
  801a4f:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
  801a56:	eb 11                	jmp    801a69 <ls+0x96>
    case 'b': type = 4; break;
  801a58:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  801a5f:	eb 08                	jmp    801a69 <ls+0x96>
    default:  type = 5; break;
  801a61:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
  801a68:	90                   	nop
    }

    printf(" @ is %s", filetype[type]);
  801a69:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a6c:	8b 04 85 10 30 80 00 	mov    0x803010(,%eax,4),%eax
  801a73:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a77:	c7 44 24 04 38 20 80 	movl   $0x802038,0x4(%esp)
  801a7e:	00 
  801a7f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a86:	e8 36 ea ff ff       	call   8004c1 <fprintf>
  ...
  801a95:	c7 44 24 04 41 20 80 	movl   $0x802041,0x4(%esp)
  801a9c:	00 
  801a9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801aa4:	e8 18 ea ff ff       	call   8004c1 <fprintf>
  ...
  801ab3:	c7 44 24 04 4d 20 80 	movl   $0x80204d,0x4(%esp)
  801aba:	00 
  801abb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ac2:	e8 fa e9 ff ff       	call   8004c1 <fprintf>
    printf(" %d(bytes) : @'%s'\n", stat->st_size, path);
  801ac7:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801aca:	8b 40 0c             	mov    0xc(%eax),%eax
  801acd:	8b 55 08             	mov    0x8(%ebp),%edx
  801ad0:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801ad4:	89 44 24 08          	mov    %eax,0x8(%esp)
  801ad8:	c7 44 24 04 59 20 80 	movl   $0x802059,0x4(%esp)
  801adf:	00 
  801ae0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ae7:	e8 d5 e9 ff ff       	call   8004c1 <fprintf>
    if (S_ISDIR(stat->st_mode)) {
  801aec:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801aef:	8b 00                	mov    (%eax),%eax
  801af1:	25 00 70 00 00       	and    $0x7000,%eax
  801af6:	3d 00 20 00 00       	cmp    $0x2000,%eax
  801afb:	75 0d                	jne    801b0a <ls+0x137>
        return lsdir(path);
  801afd:	8b 45 08             	mov    0x8(%ebp),%eax
  801b00:	89 04 24             	mov    %eax,(%esp)
  801b03:	e8 23 fe ff ff       	call   80192b <lsdir>
  801b08:	eb 05                	jmp    801b0f <ls+0x13c>
    }
    return 0;
...
main(int argc, char **argv) {
  ...
  801b14:	83 e4 f0             	and    $0xfffffff0,%esp
  801b17:	83 ec 20             	sub    $0x20,%esp
    if (argc == 1) {
  801b1a:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  801b1e:	75 0e                	jne    801b2e <main+0x1d>
        return ls(".");
  801b20:	c7 04 24 27 20 80 00 	movl   $0x802027,(%esp)
  801b27:	e8 a7 fe ff ff       	call   8019d3 <ls>
  801b2c:	eb 48                	jmp    801b76 <main+0x65>
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801b2e:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  801b35:	00 
  801b36:	eb 30                	jmp    801b68 <main+0x57>
            if ((ret = ls(argv[i])) != 0) {
  801b38:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b3c:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801b43:	8b 45 0c             	mov    0xc(%ebp),%eax
  801b46:	01 d0                	add    %edx,%eax
  801b48:	8b 00                	mov    (%eax),%eax
  801b4a:	89 04 24             	mov    %eax,(%esp)
  801b4d:	e8 81 fe ff ff       	call   8019d3 <ls>
  801b52:	89 44 24 18          	mov    %eax,0x18(%esp)
  801b56:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801b5b:	74 06                	je     801b63 <main+0x52>
                return ret;
  801b5d:	8b 44 24 18          	mov    0x18(%esp),%eax
  801b61:	eb 13                	jmp    801b76 <main+0x65>
    if (argc == 1) {
        return ls(".");
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801b63:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801b68:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b6c:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b6f:	7c c7                	jl     801b38 <main+0x27>
            if ((ret = ls(argv[i])) != 0) {
                return ret;
            }
        }
