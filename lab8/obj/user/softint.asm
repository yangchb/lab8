...
main(void) {
  ...
  8017d1:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  8017d4:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  8017d6:	c7 44 24 08 80 1c 80 	movl   $0x801c80,0x8(%esp)
  8017dd:	00 
  8017de:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  8017e5:	00 
  8017e6:	c7 04 24 8b 1c 80 00 	movl   $0x801c8b,(%esp)
  8017ed:	e8 fa ea ff ff       	call   8002ec <__panic>
