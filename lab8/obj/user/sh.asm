...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 00 20 80 00 	movl   $0x802000,(%esp)
  ...
  80029a:	c7 04 24 1d 20 80 00 	movl   $0x80201d,(%esp)
  ...
  8002b0:	c7 04 24 30 20 80 00 	movl   $0x802030,(%esp)
  ...
  8002c6:	c7 04 24 43 20 80 00 	movl   $0x802043,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 56 20 80 00 	movl   $0x802056,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 70 20 80 00 	movl   $0x802070,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 72 20 80 00 	movl   $0x802072,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 70 20 80 00 	movl   $0x802070,(%esp)
...
lock_fork(void) {
  ...
  80089d:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  8008a0:	c7 04 24 20 30 80 00 	movl   $0x803020,(%esp)
...
unlock_fork(void) {
  ...
  8008b1:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  8008b4:	c7 04 24 20 30 80 00 	movl   $0x803020,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 8e 20 80 00 	movl   $0x80208e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 a1 20 80 	movl   $0x8020a1,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 a8 20 80 	movl   $0x8020a8,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 c2 20 80 00 	movl   $0x8020c2,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 d4 20 80 	movl   $0x8020d4,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 dc 20 80 	movl   $0x8020dc,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 c2 20 80 00 	movl   $0x8020c2,(%esp)
  ...
  800ad5:	e8 95 13 00 00       	call   801e6f <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 04 23 80 00       	add    $0x802304,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 28 23 80 00 	mov    0x802328(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c 1e 23 80 	movl   $0x80231e,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be 21 23 80 00       	mov    $0x802321,%esi
            }
            if (width > 0 && padc != '-') {
...
rand(void) {
  ...
  80121d:	a1 08 30 80 00       	mov    0x803008,%eax
  801222:	8b 15 0c 30 80 00    	mov    0x80300c,%edx
  ...
  80124f:	89 0d 08 30 80 00    	mov    %ecx,0x803008
  801255:	89 1d 0c 30 80 00    	mov    %ebx,0x80300c
    unsigned long long result = (next >> 12);
  80125b:	a1 08 30 80 00       	mov    0x803008,%eax
  801260:	8b 15 0c 30 80 00    	mov    0x80300c,%edx
...
srand(unsigned int seed) {
  ...
  8012df:	a3 08 30 80 00       	mov    %eax,0x803008
  8012e4:	89 15 0c 30 80 00    	mov    %edx,0x80300c
}
  8012ea:	5d                   	pop    %ebp
  8012eb:	c3                   	ret    
...
gettoken(char **p1, char **p2) {
  ...
  8017d9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  8017dd:	75 0a                	jne    8017e9 <gettoken+0x1e>
        return 0;
  8017df:	b8 00 00 00 00       	mov    $0x0,%eax
  8017e4:	e9 f8 00 00 00       	jmp    8018e1 <gettoken+0x116>
    }
    while (strchr(WHITESPACE, *s) != NULL) {
  8017e9:	eb 0c                	jmp    8017f7 <gettoken+0x2c>
        *s ++ = '\0';
  8017eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017ee:	8d 50 01             	lea    0x1(%eax),%edx
  8017f1:	89 55 f4             	mov    %edx,-0xc(%ebp)
...
gettoken(char **p1, char **p2) {
  ...
  801804:	c7 04 24 80 24 80 00 	movl   $0x802480,(%esp)
  80180b:	e8 73 fc ff ff       	call   801483 <strchr>
  801810:	85 c0                	test   %eax,%eax
  801812:	75 d7                	jne    8017eb <gettoken+0x20>
        *s ++ = '\0';
    }
    if (*s == '\0') {
  ...
  80181c:	75 0a                	jne    801828 <gettoken+0x5d>
        return 0;
  80181e:	b8 00 00 00 00       	mov    $0x0,%eax
  801823:	e9 b9 00 00 00       	jmp    8018e1 <gettoken+0x116>
    }
  ...
  80182e:	89 10                	mov    %edx,(%eax)
    int token = 'w';
  801830:	c7 45 f0 77 00 00 00 	movl   $0x77,-0x10(%ebp)
    if (strchr(SYMBOLS, *s) != NULL) {
  801837:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80183a:	0f b6 00             	movzbl (%eax),%eax
  80183d:	0f be c0             	movsbl %al,%eax
  801840:	89 44 24 04          	mov    %eax,0x4(%esp)
  801844:	c7 04 24 85 24 80 00 	movl   $0x802485,(%esp)
  80184b:	e8 33 fc ff ff       	call   801483 <strchr>
  801850:	85 c0                	test   %eax,%eax
  801852:	74 1a                	je     80186e <gettoken+0xa3>
        token = *s, *s ++ = '\0';
  ...
  80186c:	eb 57                	jmp    8018c5 <gettoken+0xfa>
    }
    else {
        bool flag = 0;
  80186e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
        while (*s != '\0' && (flag || strchr(WHITESPACE SYMBOLS, *s) == NULL)) {
  801875:	eb 21                	jmp    801898 <gettoken+0xcd>
            if (*s == '"') {
  801877:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80187a:	0f b6 00             	movzbl (%eax),%eax
  80187d:	3c 22                	cmp    $0x22,%al
  80187f:	75 13                	jne    801894 <gettoken+0xc9>
                *s = ' ', flag = !flag;
  801881:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801884:	c6 00 20             	movb   $0x20,(%eax)
  801887:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  80188b:	0f 94 c0             	sete   %al
  80188e:	0f b6 c0             	movzbl %al,%eax
  801891:	89 45 ec             	mov    %eax,-0x14(%ebp)
            }
            s ++;
  ...
  80189b:	0f b6 00             	movzbl (%eax),%eax
  80189e:	84 c0                	test   %al,%al
  8018a0:	74 23                	je     8018c5 <gettoken+0xfa>
  8018a2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8018a6:	75 cf                	jne    801877 <gettoken+0xac>
  8018a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8018ab:	0f b6 00             	movzbl (%eax),%eax
  8018ae:	0f be c0             	movsbl %al,%eax
  8018b1:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018b5:	c7 04 24 8b 24 80 00 	movl   $0x80248b,(%esp)
  8018bc:	e8 c2 fb ff ff       	call   801483 <strchr>
  8018c1:	85 c0                	test   %eax,%eax
  8018c3:	74 b2                	je     801877 <gettoken+0xac>
                *s = ' ', flag = !flag;
            }
            s ++;
        }
  ...
  8018c8:	0f b6 00             	movzbl (%eax),%eax
  8018cb:	84 c0                	test   %al,%al
  8018cd:	74 05                	je     8018d4 <gettoken+0x109>
  8018cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8018d2:	eb 05                	jmp    8018d9 <gettoken+0x10e>
...
readline(const char *prompt) {
  ...
  8018ed:	74 1b                	je     80190a <readline+0x27>
        printf("%s", prompt);
  8018ef:	8b 45 08             	mov    0x8(%ebp),%eax
  8018f2:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018f6:	c7 44 24 04 95 24 80 	movl   $0x802495,0x4(%esp)
  8018fd:	00 
  8018fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801905:	e8 b7 eb ff ff       	call   8004c1 <fprintf>
    }
    int ret, i = 0;
  ...
  801911:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  801918:	00 
  801919:	8d 45 ef             	lea    -0x11(%ebp),%eax
  80191c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801920:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801927:	e8 f9 e7 ff ff       	call   800125 <read>
  80192c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80192f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801933:	79 0a                	jns    80193f <readline+0x5c>
            return NULL;
  801935:	b8 00 00 00 00       	mov    $0x0,%eax
  80193a:	e9 f6 00 00 00       	jmp    801a35 <readline+0x152>
        }
        else if (ret == 0) {
  80193f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801943:	75 20                	jne    801965 <readline+0x82>
            if (i > 0) {
  801945:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801949:	7e 10                	jle    80195b <readline+0x78>
                buffer[i] = '\0';
  80194b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80194e:	05 40 30 80 00       	add    $0x803040,%eax
  801953:	c6 00 00             	movb   $0x0,(%eax)
                break;
  801956:	e9 d5 00 00 00       	jmp    801a30 <readline+0x14d>
            }
            return NULL;
  80195b:	b8 00 00 00 00       	mov    $0x0,%eax
  801960:	e9 d0 00 00 00       	jmp    801a35 <readline+0x152>
        }

        if (c == 3) {
  801965:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801969:	3c 03                	cmp    $0x3,%al
  80196b:	75 0a                	jne    801977 <readline+0x94>
            return NULL;
  80196d:	b8 00 00 00 00       	mov    $0x0,%eax
  801972:	e9 be 00 00 00       	jmp    801a35 <readline+0x152>
        }
        else if (c >= ' ' && i < BUFSIZE - 1) {
  801977:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  80197b:	3c 1f                	cmp    $0x1f,%al
  80197d:	7e 3d                	jle    8019bc <readline+0xd9>
  80197f:	81 7d f4 fe 0f 00 00 	cmpl   $0xffe,-0xc(%ebp)
  801986:	7f 34                	jg     8019bc <readline+0xd9>
            putc(c);
  801988:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  80198c:	0f be c0             	movsbl %al,%eax
  80198f:	89 44 24 08          	mov    %eax,0x8(%esp)
  801993:	c7 44 24 04 98 24 80 	movl   $0x802498,0x4(%esp)
  80199a:	00 
  80199b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8019a2:	e8 1a eb ff ff       	call   8004c1 <fprintf>
            buffer[i ++] = c;
  8019a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019aa:	8d 50 01             	lea    0x1(%eax),%edx
  8019ad:	89 55 f4             	mov    %edx,-0xc(%ebp)
  8019b0:	0f b6 55 ef          	movzbl -0x11(%ebp),%edx
  8019b4:	88 90 40 30 80 00    	mov    %dl,0x803040(%eax)
  8019ba:	eb 6f                	jmp    801a2b <readline+0x148>
        }
        else if (c == '\b' && i > 0) {
  8019bc:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  8019c0:	3c 08                	cmp    $0x8,%al
  8019c2:	75 2b                	jne    8019ef <readline+0x10c>
  8019c4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  8019c8:	7e 25                	jle    8019ef <readline+0x10c>
            putc(c);
  8019ca:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  8019ce:	0f be c0             	movsbl %al,%eax
  8019d1:	89 44 24 08          	mov    %eax,0x8(%esp)
  8019d5:	c7 44 24 04 98 24 80 	movl   $0x802498,0x4(%esp)
  8019dc:	00 
  8019dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8019e4:	e8 d8 ea ff ff       	call   8004c1 <fprintf>
            i --;
  8019e9:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
  8019ed:	eb 3c                	jmp    801a2b <readline+0x148>
        }
        else if (c == '\n' || c == '\r') {
  8019ef:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  8019f3:	3c 0a                	cmp    $0xa,%al
  8019f5:	74 08                	je     8019ff <readline+0x11c>
  8019f7:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  8019fb:	3c 0d                	cmp    $0xd,%al
  8019fd:	75 2c                	jne    801a2b <readline+0x148>
            putc(c);
  8019ff:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801a03:	0f be c0             	movsbl %al,%eax
  801a06:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a0a:	c7 44 24 04 98 24 80 	movl   $0x802498,0x4(%esp)
  801a11:	00 
  801a12:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a19:	e8 a3 ea ff ff       	call   8004c1 <fprintf>
            buffer[i] = '\0';
  801a1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a21:	05 40 30 80 00       	add    $0x803040,%eax
  801a26:	c6 00 00             	movb   $0x0,(%eax)
            break;
  801a29:	eb 05                	jmp    801a30 <readline+0x14d>
        }
    }
  801a2b:	e9 e1 fe ff ff       	jmp    801911 <readline+0x2e>
    return buffer;
  801a30:	b8 40 30 80 00       	mov    $0x803040,%eax
}
  801a35:	c9                   	leave  
  801a36:	c3                   	ret    
...
usage(void) {
  ...
  801a3d:	c7 44 24 04 9b 24 80 	movl   $0x80249b,0x4(%esp)
  801a44:	00 
  801a45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a4c:	e8 70 ea ff ff       	call   8004c1 <fprintf>
}
  801a51:	c9                   	leave  
  801a52:	c3                   	ret    
...
reopen(int fd2, const char *filename, uint32_t open_flags) {
  ...
  801a5f:	e8 ae e6 ff ff       	call   800112 <close>
  ...
  801a71:	e8 82 e6 ff ff       	call   8000f8 <open>
  801a76:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801a79:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801a7d:	78 39                	js     801ab8 <reopen+0x65>
  801a7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a82:	3b 45 08             	cmp    0x8(%ebp),%eax
  801a85:	74 31                	je     801ab8 <reopen+0x65>
        close(fd2);
  801a87:	8b 45 08             	mov    0x8(%ebp),%eax
  801a8a:	89 04 24             	mov    %eax,(%esp)
  801a8d:	e8 80 e6 ff ff       	call   800112 <close>
  ...
  801aa5:	e8 0b e7 ff ff       	call   8001b5 <dup2>
  801aaa:	89 45 f4             	mov    %eax,-0xc(%ebp)
        close(fd1);
  801aad:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801ab0:	89 04 24             	mov    %eax,(%esp)
  801ab3:	e8 5a e6 ff ff       	call   800112 <close>
    }
    return ret < 0 ? ret : 0;
  801ab8:	b8 00 00 00 00       	mov    $0x0,%eax
  801abd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801ac1:	0f 4e 45 f4          	cmovle -0xc(%ebp),%eax
}
  801ac5:	c9                   	leave  
  801ac6:	c3                   	ret    
...
testfile(const char *name) {
  ...
  801adb:	e8 18 e6 ff ff       	call   8000f8 <open>
  801ae0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801ae3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801ae7:	79 05                	jns    801aee <testfile+0x27>
        return ret;
  801ae9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801aec:	eb 10                	jmp    801afe <testfile+0x37>
    }
    close(ret);
  801aee:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801af1:	89 04 24             	mov    %eax,(%esp)
  801af4:	e8 19 e6 ff ff       	call   800112 <close>
    return 0;
...
runcmd(char *cmd) {
  ...
  801b03:	81 ec b8 00 00 00    	sub    $0xb8,%esp
...
again:
  ...
  801b10:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
  801b16:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b1a:	8d 45 08             	lea    0x8(%ebp),%eax
  801b1d:	89 04 24             	mov    %eax,(%esp)
  801b20:	e8 a6 fc ff ff       	call   8017cb <gettoken>
  801b25:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801b28:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b2b:	83 f8 3c             	cmp    $0x3c,%eax
  801b2e:	74 76                	je     801ba6 <runcmd+0xa6>
  801b30:	83 f8 3c             	cmp    $0x3c,%eax
  801b33:	7f 16                	jg     801b4b <runcmd+0x4b>
  801b35:	85 c0                	test   %eax,%eax
  801b37:	0f 84 62 02 00 00    	je     801d9f <runcmd+0x29f>
  801b3d:	83 f8 3b             	cmp    $0x3b,%eax
  801b40:	0f 84 f9 01 00 00    	je     801d3f <runcmd+0x23f>
  801b46:	e9 2a 02 00 00       	jmp    801d75 <runcmd+0x275>
  801b4b:	83 f8 77             	cmp    $0x77,%eax
  801b4e:	74 17                	je     801b67 <runcmd+0x67>
  801b50:	83 f8 7c             	cmp    $0x7c,%eax
  801b53:	0f 84 25 01 00 00    	je     801c7e <runcmd+0x17e>
  801b59:	83 f8 3e             	cmp    $0x3e,%eax
  801b5c:	0f 84 b0 00 00 00    	je     801c12 <runcmd+0x112>
  801b62:	e9 0e 02 00 00       	jmp    801d75 <runcmd+0x275>
        case 'w':
            if (argc == EXEC_MAX_ARG_NUM) {
  801b67:	83 7d f4 20          	cmpl   $0x20,-0xc(%ebp)
  801b6b:	75 1e                	jne    801b8b <runcmd+0x8b>
                printf("sh error: too many arguments\n");
  801b6d:	c7 44 24 04 b5 24 80 	movl   $0x8024b5,0x4(%esp)
  801b74:	00 
  801b75:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b7c:	e8 40 e9 ff ff       	call   8004c1 <fprintf>
                return -1;
  801b81:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801b86:	e9 e2 02 00 00       	jmp    801e6d <runcmd+0x36d>
            }
            argv[argc ++] = t;
  801b8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b8e:	8d 50 01             	lea    0x1(%eax),%edx
  801b91:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801b94:	8b 95 64 ff ff ff    	mov    -0x9c(%ebp),%edx
  801b9a:	89 94 85 68 ff ff ff 	mov    %edx,-0x98(%ebp,%eax,4)
            break;
  801ba1:	e9 f4 01 00 00       	jmp    801d9a <runcmd+0x29a>
        case '<':
            if (gettoken(&cmd, &t) != 'w') {
  801ba6:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
  801bac:	89 44 24 04          	mov    %eax,0x4(%esp)
  801bb0:	8d 45 08             	lea    0x8(%ebp),%eax
  801bb3:	89 04 24             	mov    %eax,(%esp)
  801bb6:	e8 10 fc ff ff       	call   8017cb <gettoken>
  801bbb:	83 f8 77             	cmp    $0x77,%eax
  801bbe:	74 1e                	je     801bde <runcmd+0xde>
                printf("sh error: syntax error: < not followed by word\n");
  801bc0:	c7 44 24 04 d4 24 80 	movl   $0x8024d4,0x4(%esp)
  801bc7:	00 
  801bc8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801bcf:	e8 ed e8 ff ff       	call   8004c1 <fprintf>
                return -1;
  801bd4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801bd9:	e9 8f 02 00 00       	jmp    801e6d <runcmd+0x36d>
            }
            if ((ret = reopen(0, t, O_RDONLY)) != 0) {
  801bde:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
  801be4:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  801beb:	00 
  801bec:	89 44 24 04          	mov    %eax,0x4(%esp)
  801bf0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801bf7:	e8 57 fe ff ff       	call   801a53 <reopen>
  801bfc:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801bff:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801c03:	74 08                	je     801c0d <runcmd+0x10d>
                return ret;
  801c05:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801c08:	e9 60 02 00 00       	jmp    801e6d <runcmd+0x36d>
            }
            break;
  801c0d:	e9 88 01 00 00       	jmp    801d9a <runcmd+0x29a>
        case '>':
            if (gettoken(&cmd, &t) != 'w') {
  801c12:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
  801c18:	89 44 24 04          	mov    %eax,0x4(%esp)
  801c1c:	8d 45 08             	lea    0x8(%ebp),%eax
  801c1f:	89 04 24             	mov    %eax,(%esp)
  801c22:	e8 a4 fb ff ff       	call   8017cb <gettoken>
  801c27:	83 f8 77             	cmp    $0x77,%eax
  801c2a:	74 1e                	je     801c4a <runcmd+0x14a>
                printf("sh error: syntax error: > not followed by word\n");
  801c2c:	c7 44 24 04 04 25 80 	movl   $0x802504,0x4(%esp)
  801c33:	00 
  801c34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c3b:	e8 81 e8 ff ff       	call   8004c1 <fprintf>
                return -1;
  801c40:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801c45:	e9 23 02 00 00       	jmp    801e6d <runcmd+0x36d>
            }
            if ((ret = reopen(1, t, O_RDWR | O_TRUNC | O_CREAT)) != 0) {
  801c4a:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
  801c50:	c7 44 24 08 16 00 00 	movl   $0x16,0x8(%esp)
  801c57:	00 
  801c58:	89 44 24 04          	mov    %eax,0x4(%esp)
  801c5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c63:	e8 eb fd ff ff       	call   801a53 <reopen>
  801c68:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801c6b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801c6f:	74 08                	je     801c79 <runcmd+0x179>
                return ret;
  801c71:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801c74:	e9 f4 01 00 00       	jmp    801e6d <runcmd+0x36d>
            }
            break;
  801c79:	e9 1c 01 00 00       	jmp    801d9a <runcmd+0x29a>
        case '|':
          //  if ((ret = pipe(p)) != 0) {
          //      return ret;
          //  }
            if ((ret = fork()) == 0) {
  801c7e:	e8 5e ec ff ff       	call   8008e1 <fork>
  801c83:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801c86:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801c8a:	75 54                	jne    801ce0 <runcmd+0x1e0>
                close(0);
  801c8c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801c93:	e8 7a e4 ff ff       	call   800112 <close>
                if ((ret = dup2(p[0], 0)) < 0) {
  801c98:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
  801c9e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801ca5:	00 
  801ca6:	89 04 24             	mov    %eax,(%esp)
  801ca9:	e8 07 e5 ff ff       	call   8001b5 <dup2>
  801cae:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801cb1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801cb5:	79 08                	jns    801cbf <runcmd+0x1bf>
                    return ret;
  801cb7:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801cba:	e9 ae 01 00 00       	jmp    801e6d <runcmd+0x36d>
                }
                close(p[0]), close(p[1]);
  801cbf:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
  801cc5:	89 04 24             	mov    %eax,(%esp)
  801cc8:	e8 45 e4 ff ff       	call   800112 <close>
  801ccd:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
  801cd3:	89 04 24             	mov    %eax,(%esp)
  801cd6:	e8 37 e4 ff ff       	call   800112 <close>
                goto again;
  801cdb:	e9 29 fe ff ff       	jmp    801b09 <runcmd+0x9>
            }
            else {
                if (ret < 0) {
  801ce0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801ce4:	79 08                	jns    801cee <runcmd+0x1ee>
                    return ret;
  801ce6:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801ce9:	e9 7f 01 00 00       	jmp    801e6d <runcmd+0x36d>
                }
                close(1);
  801cee:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801cf5:	e8 18 e4 ff ff       	call   800112 <close>
                if ((ret = dup2(p[1], 1)) < 0) {
  801cfa:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
  801d00:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  801d07:	00 
  801d08:	89 04 24             	mov    %eax,(%esp)
  801d0b:	e8 a5 e4 ff ff       	call   8001b5 <dup2>
  801d10:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801d13:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801d17:	79 08                	jns    801d21 <runcmd+0x221>
                    return ret;
  801d19:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801d1c:	e9 4c 01 00 00       	jmp    801e6d <runcmd+0x36d>
                }
                close(p[0]), close(p[1]);
  801d21:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
  801d27:	89 04 24             	mov    %eax,(%esp)
  801d2a:	e8 e3 e3 ff ff       	call   800112 <close>
  801d2f:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
  801d35:	89 04 24             	mov    %eax,(%esp)
  801d38:	e8 d5 e3 ff ff       	call   800112 <close>
                goto runit;
  801d3d:	eb 61                	jmp    801da0 <runcmd+0x2a0>
            }
            break;
        case 0:
            goto runit;
        case ';':
            if ((ret = fork()) == 0) {
  801d3f:	e8 9d eb ff ff       	call   8008e1 <fork>
  801d44:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801d47:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801d4b:	75 02                	jne    801d4f <runcmd+0x24f>
                goto runit;
  801d4d:	eb 51                	jmp    801da0 <runcmd+0x2a0>
            }
            else {
                if (ret < 0) {
  801d4f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801d53:	79 08                	jns    801d5d <runcmd+0x25d>
                    return ret;
  801d55:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801d58:	e9 10 01 00 00       	jmp    801e6d <runcmd+0x36d>
                }
                waitpid(ret, NULL);
  801d5d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801d64:	00 
  801d65:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801d68:	89 04 24             	mov    %eax,(%esp)
  801d6b:	e8 9a eb ff ff       	call   80090a <waitpid>
                goto again;
  801d70:	e9 94 fd ff ff       	jmp    801b09 <runcmd+0x9>
            }
            break;
        default:
  ...
  801d7c:	c7 44 24 04 34 25 80 	movl   $0x802534,0x4(%esp)
  801d83:	00 
  801d84:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801d8b:	e8 31 e7 ff ff       	call   8004c1 <fprintf>
            return -1;
  801d90:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801d95:	e9 d3 00 00 00       	jmp    801e6d <runcmd+0x36d>
        }
    }
  801d9a:	e9 71 fd ff ff       	jmp    801b10 <runcmd+0x10>
                close(p[0]), close(p[1]);
                goto runit;
            }
            break;
...
runit:
  ...
  801da4:	75 0a                	jne    801db0 <runcmd+0x2b0>
        return 0;
  801da6:	b8 00 00 00 00       	mov    $0x0,%eax
  801dab:	e9 bd 00 00 00       	jmp    801e6d <runcmd+0x36d>
    }
    else if (strcmp(argv[0], "cd") == 0) {
  801db0:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  801db6:	c7 44 24 04 5b 25 80 	movl   $0x80255b,0x4(%esp)
  801dbd:	00 
  801dbe:	89 04 24             	mov    %eax,(%esp)
  801dc1:	e8 1e f6 ff ff       	call   8013e4 <strcmp>
  801dc6:	85 c0                	test   %eax,%eax
  801dc8:	75 2d                	jne    801df7 <runcmd+0x2f7>
        if (argc != 2) {
  801dca:	83 7d f4 02          	cmpl   $0x2,-0xc(%ebp)
  801dce:	74 0a                	je     801dda <runcmd+0x2da>
            return -1;
  801dd0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801dd5:	e9 93 00 00 00       	jmp    801e6d <runcmd+0x36d>
        }
        strcpy(shcwd, argv[1]);
  801dda:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
  801de0:	89 44 24 04          	mov    %eax,0x4(%esp)
  801de4:	c7 04 24 60 51 80 00 	movl   $0x805160,(%esp)
  801deb:	e8 7b f5 ff ff       	call   80136b <strcpy>
        return 0;
  801df0:	b8 00 00 00 00       	mov    $0x0,%eax
  801df5:	eb 76                	jmp    801e6d <runcmd+0x36d>
    }
    if ((ret = testfile(argv[0])) != 0) {
  801df7:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  801dfd:	89 04 24             	mov    %eax,(%esp)
  801e00:	e8 c2 fc ff ff       	call   801ac7 <testfile>
  801e05:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801e08:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801e0c:	74 3b                	je     801e49 <runcmd+0x349>
        if (ret != -E_NOENT) {
  801e0e:	83 7d ec f0          	cmpl   $0xfffffff0,-0x14(%ebp)
  801e12:	74 05                	je     801e19 <runcmd+0x319>
            return ret;
  801e14:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801e17:	eb 54                	jmp    801e6d <runcmd+0x36d>
        }
        snprintf(argv0, sizeof(argv0), "/%s", argv[0]);
  801e19:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  801e1f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801e23:	c7 44 24 08 5e 25 80 	movl   $0x80255e,0x8(%esp)
  801e2a:	00 
  801e2b:	c7 44 24 04 00 10 00 	movl   $0x1000,0x4(%esp)
  801e32:	00 
  801e33:	c7 04 24 40 40 80 00 	movl   $0x804040,(%esp)
  801e3a:	e8 35 f3 ff ff       	call   801174 <snprintf>
        argv[0] = argv0;
  801e3f:	c7 85 68 ff ff ff 40 	movl   $0x804040,-0x98(%ebp)
  801e46:	40 80 00 
    }
    argv[argc] = NULL;
  801e49:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801e4c:	c7 84 85 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%eax,4)
  801e53:	00 00 00 00 
    return __exec(NULL, argv);
  801e57:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  801e5d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801e61:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801e68:	e8 24 eb ff ff       	call   800991 <__exec>
}
  801e6d:	c9                   	leave  
  801e6e:	c3                   	ret    
...
main(int argc, char **argv) {
  ...
  801e72:	83 e4 f0             	and    $0xfffffff0,%esp
  801e75:	83 ec 20             	sub    $0x20,%esp
    printf("user sh is running!!!");
  801e78:	c7 44 24 04 62 25 80 	movl   $0x802562,0x4(%esp)
  801e7f:	00 
  801e80:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801e87:	e8 35 e6 ff ff       	call   8004c1 <fprintf>
    int ret, interactive = 1;
  801e8c:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  801e93:	00 
    if (argc == 2) {
  801e94:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
  801e98:	75 3f                	jne    801ed9 <main+0x6a>
        if ((ret = reopen(0, argv[1], O_RDONLY)) != 0) {
  801e9a:	8b 45 0c             	mov    0xc(%ebp),%eax
  801e9d:	83 c0 04             	add    $0x4,%eax
  801ea0:	8b 00                	mov    (%eax),%eax
  801ea2:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  801ea9:	00 
  801eaa:	89 44 24 04          	mov    %eax,0x4(%esp)
  801eae:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801eb5:	e8 99 fb ff ff       	call   801a53 <reopen>
  801eba:	89 44 24 10          	mov    %eax,0x10(%esp)
  801ebe:	8b 44 24 10          	mov    0x10(%esp),%eax
  801ec2:	85 c0                	test   %eax,%eax
  801ec4:	74 09                	je     801ecf <main+0x60>
            return ret;
  801ec6:	8b 44 24 10          	mov    0x10(%esp),%eax
  801eca:	e9 10 01 00 00       	jmp    801fdf <main+0x170>
        }
        interactive = 0;
  801ecf:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801ed6:	00 
  801ed7:	eb 15                	jmp    801eee <main+0x7f>
    }
    else if (argc > 2) {
  801ed9:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
  801edd:	7e 0f                	jle    801eee <main+0x7f>
        usage();
  801edf:	e8 53 fb ff ff       	call   801a37 <usage>
        return -1;
  801ee4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801ee9:	e9 f1 00 00 00       	jmp    801fdf <main+0x170>
    }
  ...
  801eee:	e9 bd 00 00 00       	jmp    801fb0 <main+0x141>
        shcwd[0] = '\0';
  801ef3:	c6 05 60 51 80 00 00 	movb   $0x0,0x805160
        int pid;
        if ((pid = fork()) == 0) {
  801efa:	e8 e2 e9 ff ff       	call   8008e1 <fork>
  801eff:	89 44 24 14          	mov    %eax,0x14(%esp)
  801f03:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  801f08:	75 1c                	jne    801f26 <main+0xb7>
            ret = runcmd(buffer);
  801f0a:	8b 44 24 18          	mov    0x18(%esp),%eax
  801f0e:	89 04 24             	mov    %eax,(%esp)
  801f11:	e8 ea fb ff ff       	call   801b00 <runcmd>
  801f16:	89 44 24 10          	mov    %eax,0x10(%esp)
            exit(ret);
  801f1a:	8b 44 24 10          	mov    0x10(%esp),%eax
  801f1e:	89 04 24             	mov    %eax,(%esp)
  801f21:	e8 9c e9 ff ff       	call   8008c2 <exit>
        }
        assert(pid >= 0);
  801f26:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  801f2b:	79 24                	jns    801f51 <main+0xe2>
  801f2d:	c7 44 24 0c 78 25 80 	movl   $0x802578,0xc(%esp)
  801f34:	00 
  801f35:	c7 44 24 08 81 25 80 	movl   $0x802581,0x8(%esp)
  801f3c:	00 
  801f3d:	c7 44 24 04 f2 00 00 	movl   $0xf2,0x4(%esp)
  801f44:	00 
  801f45:	c7 04 24 96 25 80 00 	movl   $0x802596,(%esp)
  801f4c:	e8 9b e3 ff ff       	call   8002ec <__panic>
        if (waitpid(pid, &ret) == 0) {
  801f51:	8d 44 24 10          	lea    0x10(%esp),%eax
  801f55:	89 44 24 04          	mov    %eax,0x4(%esp)
  801f59:	8b 44 24 14          	mov    0x14(%esp),%eax
  801f5d:	89 04 24             	mov    %eax,(%esp)
  801f60:	e8 a5 e9 ff ff       	call   80090a <waitpid>
  801f65:	85 c0                	test   %eax,%eax
  801f67:	75 47                	jne    801fb0 <main+0x141>
            if (ret == 0 && shcwd[0] != '\0') {
  801f69:	8b 44 24 10          	mov    0x10(%esp),%eax
  801f6d:	85 c0                	test   %eax,%eax
  801f6f:	75 13                	jne    801f84 <main+0x115>
  801f71:	0f b6 05 60 51 80 00 	movzbl 0x805160,%eax
  801f78:	84 c0                	test   %al,%al
  801f7a:	74 08                	je     801f84 <main+0x115>
                ret = 0;
  801f7c:	c7 44 24 10 00 00 00 	movl   $0x0,0x10(%esp)
  801f83:	00 
            }
            if (ret != 0) {
  801f84:	8b 44 24 10          	mov    0x10(%esp),%eax
  801f88:	85 c0                	test   %eax,%eax
  801f8a:	74 24                	je     801fb0 <main+0x141>
                printf("error: %d - %e\n", ret, ret);
  801f8c:	8b 54 24 10          	mov    0x10(%esp),%edx
  801f90:	8b 44 24 10          	mov    0x10(%esp),%eax
  801f94:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801f98:	89 44 24 08          	mov    %eax,0x8(%esp)
  801f9c:	c7 44 24 04 a0 25 80 	movl   $0x8025a0,0x4(%esp)
  801fa3:	00 
  801fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801fab:	e8 11 e5 ff ff       	call   8004c1 <fprintf>
    }
    //shcwd = malloc(BUFSIZE);
    assert(shcwd != NULL);
    ...
    char *buffer;
    while ((buffer = readline((interactive) ? "$ " : NULL)) != NULL) {
  801fb0:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801fb5:	74 07                	je     801fbe <main+0x14f>
  801fb7:	b8 b0 25 80 00       	mov    $0x8025b0,%eax
  801fbc:	eb 05                	jmp    801fc3 <main+0x154>
  801fbe:	b8 00 00 00 00       	mov    $0x0,%eax
  801fc3:	89 04 24             	mov    %eax,(%esp)
  801fc6:	e8 18 f9 ff ff       	call   8018e3 <readline>
  801fcb:	89 44 24 18          	mov    %eax,0x18(%esp)
  801fcf:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801fd4:	0f 85 19 ff ff ff    	jne    801ef3 <main+0x84>
            if (ret != 0) {
                printf("error: %d - %e\n", ret, ret);
            }
        }
