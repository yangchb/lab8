...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 20 19 80 00 	movl   $0x801920,(%esp)
  ...
  800284:	c7 04 24 2b 19 80 00 	movl   $0x80192b,(%esp)
  ...
  80029a:	c7 04 24 3d 19 80 00 	movl   $0x80193d,(%esp)
  ...
  8002b0:	c7 04 24 50 19 80 00 	movl   $0x801950,(%esp)
  ...
  8002c6:	c7 04 24 63 19 80 00 	movl   $0x801963,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 76 19 80 00 	movl   $0x801976,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 90 19 80 00 	movl   $0x801990,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 92 19 80 00 	movl   $0x801992,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 90 19 80 00 	movl   $0x801990,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 ae 19 80 00 	movl   $0x8019ae,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 c1 19 80 	movl   $0x8019c1,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 c8 19 80 	movl   $0x8019c8,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 e2 19 80 00 	movl   $0x8019e2,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 f4 19 80 	movl   $0x8019f4,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 fc 19 80 	movl   $0x8019fc,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 e2 19 80 00 	movl   $0x8019e2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 24 1c 80 00       	add    $0x801c24,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 48 1c 80 00 	mov    0x801c48(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c 3e 1c 80 	movl   $0x801c3e,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be 41 1c 80 00       	mov    $0x801c41,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017d1:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  8017d4:	e8 08 f1 ff ff       	call   8008e1 <fork>
  8017d9:	89 44 24 18          	mov    %eax,0x18(%esp)
  8017dd:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8017e2:	75 33                	jne    801817 <main+0x4c>
        cprintf("fork ok.\n");
  8017e4:	c7 04 24 a0 1d 80 00 	movl   $0x801da0,(%esp)
  8017eb:	e8 ed eb ff ff       	call   8003dd <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  8017f0:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017f7:	00 
  8017f8:	eb 0a                	jmp    801804 <main+0x39>
            yield();
  8017fa:	e8 25 f1 ff ff       	call   800924 <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  8017ff:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801804:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  801809:	7e ef                	jle    8017fa <main+0x2f>
            yield();
        }
        exit(0xbeaf);
  80180b:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  801812:	e8 ab f0 ff ff       	call   8008c2 <exit>
    }
    assert(pid > 0);
  801817:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80181c:	7f 24                	jg     801842 <main+0x77>
  80181e:	c7 44 24 0c aa 1d 80 	movl   $0x801daa,0xc(%esp)
  801825:	00 
  801826:	c7 44 24 08 b2 1d 80 	movl   $0x801db2,0x8(%esp)
  80182d:	00 
  80182e:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  801835:	00 
  801836:	c7 04 24 c7 1d 80 00 	movl   $0x801dc7,(%esp)
  80183d:	e8 aa ea ff ff       	call   8002ec <__panic>
    assert(waitpid(-1, NULL) != 0);
  801842:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801849:	00 
  80184a:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801851:	e8 b4 f0 ff ff       	call   80090a <waitpid>
  801856:	85 c0                	test   %eax,%eax
  801858:	75 24                	jne    80187e <main+0xb3>
  80185a:	c7 44 24 0c d5 1d 80 	movl   $0x801dd5,0xc(%esp)
  801861:	00 
  801862:	c7 44 24 08 b2 1d 80 	movl   $0x801db2,0x8(%esp)
  801869:	00 
  80186a:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  801871:	00 
  801872:	c7 04 24 c7 1d 80 00 	movl   $0x801dc7,(%esp)
  801879:	e8 6e ea ff ff       	call   8002ec <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  80187e:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  801885:	c0 
  801886:	8b 44 24 18          	mov    0x18(%esp),%eax
  80188a:	89 04 24             	mov    %eax,(%esp)
  80188d:	e8 78 f0 ff ff       	call   80090a <waitpid>
  801892:	85 c0                	test   %eax,%eax
  801894:	75 24                	jne    8018ba <main+0xef>
  801896:	c7 44 24 0c ec 1d 80 	movl   $0x801dec,0xc(%esp)
  80189d:	00 
  80189e:	c7 44 24 08 b2 1d 80 	movl   $0x801db2,0x8(%esp)
  8018a5:	00 
  8018a6:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  8018ad:	00 
  8018ae:	c7 04 24 c7 1d 80 00 	movl   $0x801dc7,(%esp)
  8018b5:	e8 32 ea ff ff       	call   8002ec <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  8018ba:	8d 44 24 14          	lea    0x14(%esp),%eax
  8018be:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018c2:	8b 44 24 18          	mov    0x18(%esp),%eax
  8018c6:	89 04 24             	mov    %eax,(%esp)
  8018c9:	e8 3c f0 ff ff       	call   80090a <waitpid>
  8018ce:	85 c0                	test   %eax,%eax
  8018d0:	75 0b                	jne    8018dd <main+0x112>
  8018d2:	8b 44 24 14          	mov    0x14(%esp),%eax
  8018d6:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8018db:	74 24                	je     801901 <main+0x136>
  8018dd:	c7 44 24 0c 14 1e 80 	movl   $0x801e14,0xc(%esp)
  8018e4:	00 
  8018e5:	c7 44 24 08 b2 1d 80 	movl   $0x801db2,0x8(%esp)
  8018ec:	00 
  8018ed:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8018f4:	00 
  8018f5:	c7 04 24 c7 1d 80 00 	movl   $0x801dc7,(%esp)
  8018fc:	e8 eb e9 ff ff       	call   8002ec <__panic>
    cprintf("badarg pass.\n");
  801901:	c7 04 24 49 1e 80 00 	movl   $0x801e49,(%esp)
  801908:	e8 d0 ea ff ff       	call   8003dd <cprintf>
    return 0;
