...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 4e 19 80 00 	movl   $0x80194e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 61 19 80 	movl   $0x801961,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 94 19 80 	movl   $0x801994,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 9c 19 80 	movl   $0x80199c,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  ...
  800ad5:	e8 45 0d 00 00       	call   80181f <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 c4 1b 80 00       	add    $0x801bc4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 e8 1b 80 00 	mov    0x801be8(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c de 1b 80 	movl   $0x801bde,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be e1 1b 80 00       	mov    $0x801be1,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  8017ce:	83 ec 28             	sub    $0x28,%esp
    int i, time = 100;
  8017d1:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  8017d8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8017df:	eb 2c                	jmp    80180d <sleepy+0x42>
        sleep(time);
  8017e1:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017e4:	89 04 24             	mov    %eax,(%esp)
  8017e7:	e8 85 f1 ff ff       	call   800971 <sleep>
        cprintf("sleep %d x %d slices.\n", i + 1, time);
  8017ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017ef:	8d 50 01             	lea    0x1(%eax),%edx
  8017f2:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017f5:	89 44 24 08          	mov    %eax,0x8(%esp)
  8017f9:	89 54 24 04          	mov    %edx,0x4(%esp)
  8017fd:	c7 04 24 40 1d 80 00 	movl   $0x801d40,(%esp)
  801804:	e8 d4 eb ff ff       	call   8003dd <cprintf>
#include <ulib.h>
...
sleepy(int pid) {
    int i, time = 100;
    for (i = 0; i < 10; i ++) {
  801809:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80180d:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  801811:	7e ce                	jle    8017e1 <sleepy+0x16>
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  801813:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80181a:	e8 a3 f0 ff ff       	call   8008c2 <exit>
...
main(void) {
  ...
  801822:	83 e4 f0             	and    $0xfffffff0,%esp
  801825:	83 ec 20             	sub    $0x20,%esp
    unsigned int time = gettime_msec();
  801828:	e8 57 f1 ff ff       	call   800984 <gettime_msec>
  80182d:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  801831:	e8 ab f0 ff ff       	call   8008e1 <fork>
  801836:	89 44 24 18          	mov    %eax,0x18(%esp)
  80183a:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80183f:	75 0c                	jne    80184d <main+0x2e>
        sleepy(pid1);
  801841:	8b 44 24 18          	mov    0x18(%esp),%eax
  801845:	89 04 24             	mov    %eax,(%esp)
  801848:	e8 7e ff ff ff       	call   8017cb <sleepy>
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  80184d:	8d 44 24 14          	lea    0x14(%esp),%eax
  801851:	89 44 24 04          	mov    %eax,0x4(%esp)
  801855:	8b 44 24 18          	mov    0x18(%esp),%eax
  801859:	89 04 24             	mov    %eax,(%esp)
  80185c:	e8 a9 f0 ff ff       	call   80090a <waitpid>
  801861:	85 c0                	test   %eax,%eax
  801863:	75 08                	jne    80186d <main+0x4e>
  801865:	8b 44 24 14          	mov    0x14(%esp),%eax
  801869:	85 c0                	test   %eax,%eax
  80186b:	74 24                	je     801891 <main+0x72>
  80186d:	c7 44 24 0c 58 1d 80 	movl   $0x801d58,0xc(%esp)
  801874:	00 
  801875:	c7 44 24 08 89 1d 80 	movl   $0x801d89,0x8(%esp)
  80187c:	00 
  80187d:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801884:	00 
  801885:	c7 04 24 9e 1d 80 00 	movl   $0x801d9e,(%esp)
  80188c:	e8 5b ea ff ff       	call   8002ec <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  801891:	e8 ee f0 ff ff       	call   800984 <gettime_msec>
  801896:	2b 44 24 1c          	sub    0x1c(%esp),%eax
  80189a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80189e:	c7 04 24 ab 1d 80 00 	movl   $0x801dab,(%esp)
  8018a5:	e8 33 eb ff ff       	call   8003dd <cprintf>
    cprintf("sleep pass.\n");
  8018aa:	c7 04 24 bc 1d 80 00 	movl   $0x801dbc,(%esp)
  8018b1:	e8 27 eb ff ff       	call   8003dd <cprintf>
    return 0;
