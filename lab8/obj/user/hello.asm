...
main(void) {
  ...
  8017d1:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  8017d4:	c7 04 24 a0 1c 80 00 	movl   $0x801ca0,(%esp)
  8017db:	e8 fd eb ff ff       	call   8003dd <cprintf>
    cprintf("I am process %d.\n", getpid());
  8017e0:	e8 5f f1 ff ff       	call   800944 <getpid>
  8017e5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017e9:	c7 04 24 b0 1c 80 00 	movl   $0x801cb0,(%esp)
  8017f0:	e8 e8 eb ff ff       	call   8003dd <cprintf>
    cprintf("hello pass.\n");
  8017f5:	c7 04 24 c2 1c 80 00 	movl   $0x801cc2,(%esp)
  8017fc:	e8 dc eb ff ff       	call   8003dd <cprintf>
    return 0;
