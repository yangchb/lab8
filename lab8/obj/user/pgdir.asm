...
main(void) {
  ...
  8017dd:	c7 04 24 a0 1c 80 00 	movl   $0x801ca0,(%esp)
  8017e4:	e8 f4 eb ff ff       	call   8003dd <cprintf>
    print_pgdir();
  8017e9:	e8 63 f1 ff ff       	call   800951 <print_pgdir>
    cprintf("pgdir pass.\n");
  8017ee:	c7 04 24 b7 1c 80 00 	movl   $0x801cb7,(%esp)
  8017f5:	e8 e3 eb ff ff       	call   8003dd <cprintf>
    return 0;
