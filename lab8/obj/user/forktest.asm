...
main(void) {
  ...
  8017d4:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017db:	00 
  8017dc:	eb 60                	jmp    80183e <main+0x73>
        if ((pid = fork()) == 0) {
  8017de:	e8 fe f0 ff ff       	call   8008e1 <fork>
  8017e3:	89 44 24 18          	mov    %eax,0x18(%esp)
  8017e7:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8017ec:	75 20                	jne    80180e <main+0x43>
            cprintf("I am child %d\n", n);
  8017ee:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8017f2:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017f6:	c7 04 24 84 1d 80 00 	movl   $0x801d84,(%esp)
  8017fd:	e8 db eb ff ff       	call   8003dd <cprintf>
            exit(0);
  801802:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801809:	e8 b4 f0 ff ff       	call   8008c2 <exit>
        }
        assert(pid > 0);
  80180e:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801813:	7f 24                	jg     801839 <main+0x6e>
  801815:	c7 44 24 0c 93 1d 80 	movl   $0x801d93,0xc(%esp)
  80181c:	00 
  80181d:	c7 44 24 08 9b 1d 80 	movl   $0x801d9b,0x8(%esp)
  801824:	00 
  801825:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80182c:	00 
  80182d:	c7 04 24 b0 1d 80 00 	movl   $0x801db0,(%esp)
  801834:	e8 b3 ea ff ff       	call   8002ec <__panic>
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  801839:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80183e:	b8 20 00 00 00       	mov    $0x20,%eax
  801843:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801847:	7c 95                	jl     8017de <main+0x13>
            exit(0);
        }
        assert(pid > 0);
    }
    ...
    if (n > max_child) {
  801849:	b8 20 00 00 00       	mov    $0x20,%eax
  80184e:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801852:	7e 24                	jle    801878 <main+0xad>
        panic("fork claimed to work %d times!\n", n);
  801854:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801858:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80185c:	c7 44 24 08 c0 1d 80 	movl   $0x801dc0,0x8(%esp)
  801863:	00 
  801864:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  80186b:	00 
  80186c:	c7 04 24 b0 1d 80 00 	movl   $0x801db0,(%esp)
  801873:	e8 74 ea ff ff       	call   8002ec <__panic>
    }

    for (; n > 0; n --) {
  801878:	eb 2a                	jmp    8018a4 <main+0xd9>
        if (wait() != 0) {
  80187a:	e8 6f f0 ff ff       	call   8008ee <wait>
  80187f:	85 c0                	test   %eax,%eax
  801881:	74 1c                	je     80189f <main+0xd4>
            panic("wait stopped early\n");
  801883:	c7 44 24 08 e0 1d 80 	movl   $0x801de0,0x8(%esp)
  80188a:	00 
  80188b:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801892:	00 
  801893:	c7 04 24 b0 1d 80 00 	movl   $0x801db0,(%esp)
  80189a:	e8 4d ea ff ff       	call   8002ec <__panic>
    ...
    for (; n > 0; n --) {
  80189f:	83 6c 24 1c 01       	subl   $0x1,0x1c(%esp)
  8018a4:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8018a9:	7f cf                	jg     80187a <main+0xaf>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  8018ab:	e8 3e f0 ff ff       	call   8008ee <wait>
  8018b0:	85 c0                	test   %eax,%eax
  8018b2:	75 1c                	jne    8018d0 <main+0x105>
        panic("wait got too many\n");
  8018b4:	c7 44 24 08 f4 1d 80 	movl   $0x801df4,0x8(%esp)
  8018bb:	00 
  8018bc:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8018c3:	00 
  8018c4:	c7 04 24 b0 1d 80 00 	movl   $0x801db0,(%esp)
  8018cb:	e8 1c ea ff ff       	call   8002ec <__panic>
    }

    cprintf("forktest pass.\n");
  8018d0:	c7 04 24 07 1e 80 00 	movl   $0x801e07,(%esp)
  8018d7:	e8 01 eb ff ff       	call   8003dd <cprintf>
    return 0;
