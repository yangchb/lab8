...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 00 19 80 00 	movl   $0x801900,(%esp)
  ...
  800284:	c7 04 24 0b 19 80 00 	movl   $0x80190b,(%esp)
  ...
  80029a:	c7 04 24 1d 19 80 00 	movl   $0x80191d,(%esp)
  ...
  8002b0:	c7 04 24 30 19 80 00 	movl   $0x801930,(%esp)
  ...
  8002c6:	c7 04 24 43 19 80 00 	movl   $0x801943,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 56 19 80 00 	movl   $0x801956,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 70 19 80 00 	movl   $0x801970,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 72 19 80 00 	movl   $0x801972,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 70 19 80 00 	movl   $0x801970,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 8e 19 80 00 	movl   $0x80198e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 a1 19 80 	movl   $0x8019a1,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 a8 19 80 	movl   $0x8019a8,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 c2 19 80 00 	movl   $0x8019c2,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 d4 19 80 	movl   $0x8019d4,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 dc 19 80 	movl   $0x8019dc,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 c2 19 80 00 	movl   $0x8019c2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 04 1c 80 00       	add    $0x801c04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 28 1c 80 00 	mov    0x801c28(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c 1e 1c 80 	movl   $0x801c1e,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be 21 1c 80 00       	mov    $0x801c21,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017d4:	c7 04 24 80 1d 80 00 	movl   $0x801d80,(%esp)
  8017db:	e8 fd eb ff ff       	call   8003dd <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  8017e0:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017e7:	00 
  8017e8:	eb 38                	jmp    801822 <main+0x57>
        if (bigarray[i] != 0) {
  8017ea:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8017ee:	8b 04 85 60 21 80 00 	mov    0x802160(,%eax,4),%eax
  8017f5:	85 c0                	test   %eax,%eax
  8017f7:	74 24                	je     80181d <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  8017f9:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8017fd:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801801:	c7 44 24 08 a0 1d 80 	movl   $0x801da0,0x8(%esp)
  801808:	00 
  801809:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801810:	00 
  801811:	c7 04 24 bd 1d 80 00 	movl   $0x801dbd,(%esp)
  801818:	e8 cf ea ff ff       	call   8002ec <__panic>
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  80181d:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801822:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801829:	00 
  80182a:	7e be                	jle    8017ea <main+0x1f>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80182c:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801833:	00 
  801834:	eb 14                	jmp    80184a <main+0x7f>
        bigarray[i] = i;
  801836:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80183a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80183e:	89 14 85 60 21 80 00 	mov    %edx,0x802160(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  801845:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80184a:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801851:	00 
  801852:	7e e2                	jle    801836 <main+0x6b>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801854:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80185b:	00 
  80185c:	eb 3c                	jmp    80189a <main+0xcf>
        if (bigarray[i] != i) {
  80185e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801862:	8b 14 85 60 21 80 00 	mov    0x802160(,%eax,4),%edx
  801869:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80186d:	39 c2                	cmp    %eax,%edx
  80186f:	74 24                	je     801895 <main+0xca>
            panic("bigarray[%d] didn't hold its value!\n", i);
  801871:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801875:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801879:	c7 44 24 08 cc 1d 80 	movl   $0x801dcc,0x8(%esp)
  801880:	00 
  801881:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  801888:	00 
  801889:	c7 04 24 bd 1d 80 00 	movl   $0x801dbd,(%esp)
  801890:	e8 57 ea ff ff       	call   8002ec <__panic>
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  801895:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80189a:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  8018a1:	00 
  8018a2:	7e ba                	jle    80185e <main+0x93>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  8018a4:	c7 04 24 f4 1d 80 00 	movl   $0x801df4,(%esp)
  8018ab:	e8 2d eb ff ff       	call   8003dd <cprintf>
    cprintf("testbss may pass.\n");
  8018b0:	c7 04 24 27 1e 80 00 	movl   $0x801e27,(%esp)
  8018b7:	e8 21 eb ff ff       	call   8003dd <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  8018bc:	c7 05 60 31 c0 00 00 	movl   $0x0,0xc03160
  8018c3:	00 00 00 
    asm volatile ("int $0x14");
  8018c6:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8018c8:	c7 44 24 08 3a 1e 80 	movl   $0x801e3a,0x8(%esp)
  8018cf:	00 
  8018d0:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8018d7:	00 
  8018d8:	c7 04 24 bd 1d 80 00 	movl   $0x801dbd,(%esp)
  8018df:	e8 08 ea ff ff       	call   8002ec <__panic>
