...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 e0 18 80 00 	movl   $0x8018e0,(%esp)
  ...
  800284:	c7 04 24 eb 18 80 00 	movl   $0x8018eb,(%esp)
  ...
  80029a:	c7 04 24 fd 18 80 00 	movl   $0x8018fd,(%esp)
  ...
  8002b0:	c7 04 24 10 19 80 00 	movl   $0x801910,(%esp)
  ...
  8002c6:	c7 04 24 23 19 80 00 	movl   $0x801923,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 36 19 80 00 	movl   $0x801936,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 50 19 80 00 	movl   $0x801950,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 52 19 80 00 	movl   $0x801952,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 50 19 80 00 	movl   $0x801950,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 6e 19 80 00 	movl   $0x80196e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 81 19 80 	movl   $0x801981,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 88 19 80 	movl   $0x801988,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 a2 19 80 00 	movl   $0x8019a2,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 b4 19 80 	movl   $0x8019b4,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 bc 19 80 	movl   $0x8019bc,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 a2 19 80 00 	movl   $0x8019a2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 e4 1b 80 00       	add    $0x801be4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 08 1c 80 00 	mov    0x801c08(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c fe 1b 80 	movl   $0x801bfe,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be 01 1c 80 00       	mov    $0x801c01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017d4:	c7 04 24 60 1d 80 00 	movl   $0x801d60,(%esp)
  ...
  8017ee:	75 0e                	jne    8017fe <main+0x33>
        cprintf("I am the child. spinning ...\n");
  8017f0:	c7 04 24 87 1d 80 00 	movl   $0x801d87,(%esp)
  8017f7:	e8 e1 eb ff ff       	call   8003dd <cprintf>
        while (1);
  8017fc:	eb fe                	jmp    8017fc <main+0x31>
    }
    cprintf("I am the parent. Running the child...\n");
  8017fe:	c7 04 24 a8 1d 80 00 	movl   $0x801da8,(%esp)
  801805:	e8 d3 eb ff ff       	call   8003dd <cprintf>

    yield();
  80180a:	e8 15 f1 ff ff       	call   800924 <yield>
    yield();
  80180f:	e8 10 f1 ff ff       	call   800924 <yield>
    yield();
  801814:	e8 0b f1 ff ff       	call   800924 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  801819:	c7 04 24 d0 1d 80 00 	movl   $0x801dd0,(%esp)
  801820:	e8 b8 eb ff ff       	call   8003dd <cprintf>

    assert((ret = kill(pid)) == 0);
  801825:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801829:	89 04 24             	mov    %eax,(%esp)
  80182c:	e8 00 f1 ff ff       	call   800931 <kill>
  801831:	89 44 24 18          	mov    %eax,0x18(%esp)
  801835:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80183a:	74 24                	je     801860 <main+0x95>
  80183c:	c7 44 24 0c f8 1d 80 	movl   $0x801df8,0xc(%esp)
  801843:	00 
  801844:	c7 44 24 08 0f 1e 80 	movl   $0x801e0f,0x8(%esp)
  80184b:	00 
  80184c:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%esp)
  801853:	00 
  801854:	c7 04 24 24 1e 80 00 	movl   $0x801e24,(%esp)
  80185b:	e8 8c ea ff ff       	call   8002ec <__panic>
    cprintf("kill returns %d\n", ret);
  801860:	8b 44 24 18          	mov    0x18(%esp),%eax
  801864:	89 44 24 04          	mov    %eax,0x4(%esp)
  801868:	c7 04 24 30 1e 80 00 	movl   $0x801e30,(%esp)
  80186f:	e8 69 eb ff ff       	call   8003dd <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  801874:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80187b:	00 
  80187c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801880:	89 04 24             	mov    %eax,(%esp)
  801883:	e8 82 f0 ff ff       	call   80090a <waitpid>
  801888:	89 44 24 18          	mov    %eax,0x18(%esp)
  80188c:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801891:	74 24                	je     8018b7 <main+0xec>
  801893:	c7 44 24 0c 44 1e 80 	movl   $0x801e44,0xc(%esp)
  80189a:	00 
  80189b:	c7 44 24 08 0f 1e 80 	movl   $0x801e0f,0x8(%esp)
  8018a2:	00 
  8018a3:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8018aa:	00 
  8018ab:	c7 04 24 24 1e 80 00 	movl   $0x801e24,(%esp)
  8018b2:	e8 35 ea ff ff       	call   8002ec <__panic>
    cprintf("wait returns %d\n", ret);
  8018b7:	8b 44 24 18          	mov    0x18(%esp),%eax
  8018bb:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018bf:	c7 04 24 64 1e 80 00 	movl   $0x801e64,(%esp)
  8018c6:	e8 12 eb ff ff       	call   8003dd <cprintf>

    cprintf("spin may pass.\n");
  8018cb:	c7 04 24 75 1e 80 00 	movl   $0x801e75,(%esp)
  8018d2:	e8 06 eb ff ff       	call   8003dd <cprintf>
    return 0;
