...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 c0 1a 80 00 	movl   $0x801ac0,(%esp)
  ...
  800284:	c7 04 24 cb 1a 80 00 	movl   $0x801acb,(%esp)
  ...
  80029a:	c7 04 24 dd 1a 80 00 	movl   $0x801add,(%esp)
  ...
  8002b0:	c7 04 24 f0 1a 80 00 	movl   $0x801af0,(%esp)
  ...
  8002c6:	c7 04 24 03 1b 80 00 	movl   $0x801b03,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 16 1b 80 00 	movl   $0x801b16,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 30 1b 80 00 	movl   $0x801b30,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 32 1b 80 00 	movl   $0x801b32,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 30 1b 80 00 	movl   $0x801b30,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 4e 1b 80 00 	movl   $0x801b4e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 61 1b 80 	movl   $0x801b61,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 68 1b 80 	movl   $0x801b68,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 82 1b 80 00 	movl   $0x801b82,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 94 1b 80 	movl   $0x801b94,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 9c 1b 80 	movl   $0x801b9c,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 82 1b 80 00 	movl   $0x801b82,(%esp)
  ...
  800ad5:	e8 1d 0d 00 00       	call   8017f7 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 c4 1d 80 00       	add    $0x801dc4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 e8 1d 80 00 	mov    0x801de8(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c de 1d 80 	movl   $0x801dde,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be e1 1d 80 00       	mov    $0x801de1,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8017d8:	eb 12                	jmp    8017ec <spin_delay+0x21>
     {
          j = !j;
  8017da:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8017dd:	85 c0                	test   %eax,%eax
  8017df:	0f 94 c0             	sete   %al
...
spin_delay(void)
{
     ...
     volatile int j;
     for (i = 0; i != 200; ++ i)
  8017e8:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  8017ec:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  8017f3:	75 e5                	jne    8017da <spin_delay+0xf>
     {
          j = !j;
     }
}
...
main(void) {
  ...
  8017fa:	56                   	push   %esi
  8017fb:	53                   	push   %ebx
  8017fc:	83 e4 f0             	and    $0xfffffff0,%esp
  8017ff:	83 ec 20             	sub    $0x20,%esp
     int i,time;
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  801802:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  801809:	00 
  80180a:	c7 04 24 40 1f 80 00 	movl   $0x801f40,(%esp)
  801811:	e8 c7 eb ff ff       	call   8003dd <cprintf>
     sleep(SLEEP_TIME);
  801816:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  80181d:	e8 4f f1 ff ff       	call   800971 <sleep>
     memset(pids, 0, sizeof(pids));
  801822:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  801829:	00 
  80182a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801831:	00 
  801832:	c7 04 24 70 31 80 00 	movl   $0x803170,(%esp)
  801839:	e8 04 fe ff ff       	call   801642 <memset>
     lab6_set_priority(TOTAL + 1);
  80183e:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  801845:	e8 14 f1 ff ff       	call   80095e <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  80184a:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801851:	00 
  801852:	e9 0e 01 00 00       	jmp    801965 <main+0x16e>
          acc[i]=0;
  801857:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80185b:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  801862:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  801866:	e8 76 f0 ff ff       	call   8008e1 <fork>
  80186b:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80186f:	89 04 95 70 31 80 00 	mov    %eax,0x803170(,%edx,4)
  801876:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80187a:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801881:	85 c0                	test   %eax,%eax
  801883:	0f 85 ba 00 00 00    	jne    801943 <main+0x14c>
               lab6_set_priority(i + 1);
  801889:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80188d:	83 c0 01             	add    $0x1,%eax
  801890:	89 04 24             	mov    %eax,(%esp)
  801893:	e8 c6 f0 ff ff       	call   80095e <lab6_set_priority>
               acc[i] = 0;
  801898:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80189c:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  8018a3:	00 00 00 00 
               while (1) {
                    spin_delay();
  8018a7:	e8 1f ff ff ff       	call   8017cb <spin_delay>
                    ++ acc[i];
  8018ac:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018b0:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  8018b7:	8d 50 01             	lea    0x1(%eax),%edx
  8018ba:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018be:	89 14 85 48 31 80 00 	mov    %edx,0x803148(,%eax,4)
                    if(acc[i]%4000==0) {
  8018c5:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018c9:	8b 0c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ecx
  8018d0:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8018d5:	89 c8                	mov    %ecx,%eax
  8018d7:	f7 e2                	mul    %edx
  8018d9:	89 d0                	mov    %edx,%eax
  8018db:	c1 e8 08             	shr    $0x8,%eax
  8018de:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8018e4:	29 c1                	sub    %eax,%ecx
  8018e6:	89 c8                	mov    %ecx,%eax
  8018e8:	85 c0                	test   %eax,%eax
  8018ea:	75 52                	jne    80193e <main+0x147>
                        if((time=gettime_msec())>MAX_TIME) {
  8018ec:	e8 93 f0 ff ff       	call   800984 <gettime_msec>
  8018f1:	89 44 24 18          	mov    %eax,0x18(%esp)
  8018f5:	81 7c 24 18 d0 07 00 	cmpl   $0x7d0,0x18(%esp)
  8018fc:	00 
  8018fd:	7e 3f                	jle    80193e <main+0x147>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  8018ff:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801903:	8b 1c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ebx
  80190a:	e8 35 f0 ff ff       	call   800944 <getpid>
  80190f:	8b 54 24 18          	mov    0x18(%esp),%edx
  801913:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801917:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80191b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80191f:	c7 04 24 68 1f 80 00 	movl   $0x801f68,(%esp)
  801926:	e8 b2 ea ff ff       	call   8003dd <cprintf>
                            exit(acc[i]);
  80192b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80192f:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  801936:	89 04 24             	mov    %eax,(%esp)
  801939:	e8 84 ef ff ff       	call   8008c2 <exit>
                        }
                    }
               }
  80193e:	e9 64 ff ff ff       	jmp    8018a7 <main+0xb0>
               
          }
          if (pids[i] < 0) {
  801943:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801947:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  80194e:	85 c0                	test   %eax,%eax
  801950:	79 0e                	jns    801960 <main+0x169>
               goto failed;
  801952:	90                   	nop
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801953:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80195a:	00 
  80195b:	e9 32 01 00 00       	jmp    801a92 <main+0x29b>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  801960:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801965:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  80196a:	0f 8e e7 fe ff ff    	jle    801857 <main+0x60>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  801970:	c7 04 24 88 1f 80 00 	movl   $0x801f88,(%esp)
  801977:	e8 61 ea ff ff       	call   8003dd <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  80197c:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801983:	00 
  801984:	eb 6b                	jmp    8019f1 <main+0x1fa>
         status[i]=0;
  801986:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80198a:	c7 04 85 5c 31 80 00 	movl   $0x0,0x80315c(,%eax,4)
  801991:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  801995:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801999:	c1 e0 02             	shl    $0x2,%eax
  80199c:	8d 90 5c 31 80 00    	lea    0x80315c(%eax),%edx
  8019a2:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8019a6:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  8019ad:	89 54 24 04          	mov    %edx,0x4(%esp)
  8019b1:	89 04 24             	mov    %eax,(%esp)
  8019b4:	e8 51 ef ff ff       	call   80090a <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8019b9:	e8 c6 ef ff ff       	call   800984 <gettime_msec>
  8019be:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019c2:	8b 0c 95 5c 31 80 00 	mov    0x80315c(,%edx,4),%ecx
  8019c9:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019cd:	8b 14 95 70 31 80 00 	mov    0x803170(,%edx,4),%edx
  8019d4:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8019d8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8019dc:	89 54 24 04          	mov    %edx,0x4(%esp)
  8019e0:	c7 04 24 b0 1f 80 00 	movl   $0x801fb0,(%esp)
  8019e7:	e8 f1 e9 ff ff       	call   8003dd <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  8019ec:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8019f1:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  8019f6:	7e 8e                	jle    801986 <main+0x18f>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  8019f8:	c7 04 24 cf 1f 80 00 	movl   $0x801fcf,(%esp)
  8019ff:	e8 d9 e9 ff ff       	call   8003dd <cprintf>
     cprintf("stride sched correct result:");
  801a04:	c7 04 24 e5 1f 80 00 	movl   $0x801fe5,(%esp)
  801a0b:	e8 cd e9 ff ff       	call   8003dd <cprintf>
     for (i = 0; i < TOTAL; i ++)
  801a10:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a17:	00 
  801a18:	eb 37                	jmp    801a51 <main+0x25a>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801a1a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a1e:	8b 04 85 5c 31 80 00 	mov    0x80315c(,%eax,4),%eax
  801a25:	01 c0                	add    %eax,%eax
  801a27:	8b 35 5c 31 80 00    	mov    0x80315c,%esi
  801a2d:	99                   	cltd   
  801a2e:	f7 fe                	idiv   %esi
  801a30:	83 c0 01             	add    $0x1,%eax
  801a33:	89 c2                	mov    %eax,%edx
  801a35:	c1 ea 1f             	shr    $0x1f,%edx
  801a38:	01 d0                	add    %edx,%eax
  801a3a:	d1 f8                	sar    %eax
  801a3c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a40:	c7 04 24 02 20 80 00 	movl   $0x802002,(%esp)
  801a47:	e8 91 e9 ff ff       	call   8003dd <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801a4c:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a51:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a56:	7e c2                	jle    801a1a <main+0x223>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  801a58:	c7 04 24 06 20 80 00 	movl   $0x802006,(%esp)
  801a5f:	e8 79 e9 ff ff       	call   8003dd <cprintf>

     return 0;
  801a64:	b8 00 00 00 00       	mov    $0x0,%eax
  801a69:	eb 4a                	jmp    801ab5 <main+0x2be>

failed:
     for (i = 0; i < TOTAL; i ++) {
          if (pids[i] > 0) {
  801a6b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a6f:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a76:	85 c0                	test   %eax,%eax
  801a78:	7e 13                	jle    801a8d <main+0x296>
               kill(pids[i]);
  801a7a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a7e:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a85:	89 04 24             	mov    %eax,(%esp)
  801a88:	e8 a4 ee ff ff       	call   800931 <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801a8d:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a92:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a97:	7e d2                	jle    801a6b <main+0x274>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  801a99:	c7 44 24 08 08 20 80 	movl   $0x802008,0x8(%esp)
  801aa0:	00 
  801aa1:	c7 44 24 04 4e 00 00 	movl   $0x4e,0x4(%esp)
  801aa8:	00 
  801aa9:	c7 04 24 13 20 80 00 	movl   $0x802013,(%esp)
  801ab0:	e8 37 e8 ff ff       	call   8002ec <__panic>
}
