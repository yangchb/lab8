...
main(void) {
  ...
  8017d1:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  8017d4:	8b 0d 48 21 80 00    	mov    0x802148,%ecx
  8017da:	b8 01 00 00 00       	mov    $0x1,%eax
  8017df:	99                   	cltd   
  8017e0:	f7 f9                	idiv   %ecx
  8017e2:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017e6:	c7 04 24 a0 1c 80 00 	movl   $0x801ca0,(%esp)
  8017ed:	e8 eb eb ff ff       	call   8003dd <cprintf>
    panic("FAIL: T.T\n");
  8017f2:	c7 44 24 08 ae 1c 80 	movl   $0x801cae,0x8(%esp)
  8017f9:	00 
  8017fa:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801801:	00 
  801802:	c7 04 24 b9 1c 80 00 	movl   $0x801cb9,(%esp)
  801809:	e8 de ea ff ff       	call   8002ec <__panic>
