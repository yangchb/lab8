...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 00 18 80 00 	movl   $0x801800,(%esp)
  ...
  800284:	c7 04 24 0b 18 80 00 	movl   $0x80180b,(%esp)
  ...
  80029a:	c7 04 24 1d 18 80 00 	movl   $0x80181d,(%esp)
  ...
  8002b0:	c7 04 24 30 18 80 00 	movl   $0x801830,(%esp)
  ...
  8002c6:	c7 04 24 43 18 80 00 	movl   $0x801843,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 56 18 80 00 	movl   $0x801856,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 70 18 80 00 	movl   $0x801870,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 72 18 80 00 	movl   $0x801872,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 70 18 80 00 	movl   $0x801870,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 8e 18 80 00 	movl   $0x80188e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 a1 18 80 	movl   $0x8018a1,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 a8 18 80 	movl   $0x8018a8,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 c2 18 80 00 	movl   $0x8018c2,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 d4 18 80 	movl   $0x8018d4,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 dc 18 80 	movl   $0x8018dc,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 c2 18 80 00 	movl   $0x8018c2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 04 1b 80 00       	add    $0x801b04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 28 1b 80 00 	mov    0x801b28(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c 1e 1b 80 	movl   $0x801b1e,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be 21 1b 80 00       	mov    $0x801b21,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017d4:	66 b8 28 00          	mov    $0x28,%ax
  8017d8:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  8017da:	c7 44 24 08 80 1c 80 	movl   $0x801c80,0x8(%esp)
  8017e1:	00 
  8017e2:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8017e9:	00 
  8017ea:	c7 04 24 8b 1c 80 00 	movl   $0x801c8b,(%esp)
  8017f1:	e8 f6 ea ff ff       	call   8002ec <__panic>
