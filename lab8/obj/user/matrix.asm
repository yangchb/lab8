...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 c0 1b 80 00 	movl   $0x801bc0,(%esp)
  ...
  800284:	c7 04 24 cb 1b 80 00 	movl   $0x801bcb,(%esp)
  ...
  80029a:	c7 04 24 dd 1b 80 00 	movl   $0x801bdd,(%esp)
  ...
  8002b0:	c7 04 24 f0 1b 80 00 	movl   $0x801bf0,(%esp)
  ...
  8002c6:	c7 04 24 03 1c 80 00 	movl   $0x801c03,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 16 1c 80 00 	movl   $0x801c16,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 30 1c 80 00 	movl   $0x801c30,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 32 1c 80 00 	movl   $0x801c32,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 30 1c 80 00 	movl   $0x801c30,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 4e 1c 80 00 	movl   $0x801c4e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 61 1c 80 	movl   $0x801c61,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 68 1c 80 	movl   $0x801c68,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 82 1c 80 00 	movl   $0x801c82,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 94 1c 80 	movl   $0x801c94,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 9c 1c 80 	movl   $0x801c9c,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 82 1c 80 00 	movl   $0x801c82,(%esp)
  ...
  800ad5:	e8 29 0f 00 00       	call   801a03 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 c4 1e 80 00       	add    $0x801ec4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 e8 1e 80 00 	mov    0x801ee8(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c de 1e 80 	movl   $0x801ede,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be e1 1e 80 00       	mov    $0x801ee1,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8017d2:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8017d9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8017e0:	eb 65                	jmp    801847 <work+0x7c>
        for (j = 0; j < size; j ++) {
  8017e2:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8017e9:	eb 50                	jmp    80183b <work+0x70>
            mata[i][j] = matb[i][j] = 1;
  ...
  8017fc:	c7 04 85 e0 31 80 00 	movl   $0x1,0x8031e0(,%eax,4)
  801803:	01 00 00 00 
  ...
  801818:	8b 0c 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%ecx
  ...
  801830:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  801837:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  80183b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80183e:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801841:	7c a8                	jl     8017eb <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
    int i, j, k, size = MATSIZE;
    for (i = 0; i < size; i ++) {
  801843:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801847:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80184a:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80184d:	7c 93                	jl     8017e2 <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  80184f:	e8 d0 f0 ff ff       	call   800924 <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801854:	e8 eb f0 ff ff       	call   800944 <getpid>
  801859:	8b 55 08             	mov    0x8(%ebp),%edx
  80185c:	89 54 24 08          	mov    %edx,0x8(%esp)
  801860:	89 44 24 04          	mov    %eax,0x4(%esp)
  801864:	c7 04 24 40 20 80 00 	movl   $0x802040,(%esp)
  80186b:	e8 6d eb ff ff       	call   8003dd <cprintf>

    while (times -- > 0) {
  801870:	e9 5c 01 00 00       	jmp    8019d1 <work+0x206>
        for (i = 0; i < size; i ++) {
  801875:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80187c:	e9 b6 00 00 00       	jmp    801937 <work+0x16c>
            for (j = 0; j < size; j ++) {
  801881:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801888:	e9 9a 00 00 00       	jmp    801927 <work+0x15c>
                matc[i][j] = 0;
  ...
  80189e:	c7 04 85 80 33 80 00 	movl   $0x0,0x803380(,%eax,4)
  8018a5:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  8018a9:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8018b0:	eb 69                	jmp    80191b <work+0x150>
  ...
  8018be:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8018c1:	01 d0                	add    %edx,%eax
  8018c3:	8b 0c 85 80 33 80 00 	mov    0x803380(,%eax,4),%ecx
  8018ca:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8018cd:	89 d0                	mov    %edx,%eax
  8018cf:	c1 e0 02             	shl    $0x2,%eax
  8018d2:	01 d0                	add    %edx,%eax
  8018d4:	01 c0                	add    %eax,%eax
  8018d6:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8018d9:	01 d0                	add    %edx,%eax
  8018db:	8b 1c 85 40 30 80 00 	mov    0x803040(,%eax,4),%ebx
  8018e2:	8b 55 ec             	mov    -0x14(%ebp),%edx
  ...
  8018f3:	8b 04 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%eax
  8018fa:	0f af c3             	imul   %ebx,%eax
  8018fd:	01 c1                	add    %eax,%ecx
  8018ff:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801902:	89 d0                	mov    %edx,%eax
  801904:	c1 e0 02             	shl    $0x2,%eax
  801907:	01 d0                	add    %edx,%eax
  801909:	01 c0                	add    %eax,%eax
  80190b:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80190e:	01 d0                	add    %edx,%eax
  801910:	89 0c 85 80 33 80 00 	mov    %ecx,0x803380(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  801917:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  80191b:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80191e:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801921:	7c 8f                	jl     8018b2 <work+0xe7>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801923:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801927:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80192a:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80192d:	0f 8c 5a ff ff ff    	jl     80188d <work+0xc2>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  801933:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801937:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80193a:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80193d:	0f 8c 3e ff ff ff    	jl     801881 <work+0xb6>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
  ...
  80194a:	eb 79                	jmp    8019c5 <work+0x1fa>
            for (j = 0; j < size; j ++) {
  80194c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801953:	eb 64                	jmp    8019b9 <work+0x1ee>
  ...
  801961:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801964:	01 d0                	add    %edx,%eax
  801966:	8b 0c 85 80 33 80 00 	mov    0x803380(,%eax,4),%ecx
  ...
  80197e:	89 0c 85 e0 31 80 00 	mov    %ecx,0x8031e0(,%eax,4)
  ...
  801996:	8b 0c 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%ecx
  ...
  8019ae:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        }
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8019b5:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  8019b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8019bc:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019bf:	7c 94                	jl     801955 <work+0x18a>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  8019c1:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8019c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019c8:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019cb:	0f 8c 7b ff ff ff    	jl     80194c <work+0x181>
  ...
  8019d4:	8d 50 ff             	lea    -0x1(%eax),%edx
  8019d7:	89 55 08             	mov    %edx,0x8(%ebp)
  8019da:	85 c0                	test   %eax,%eax
  8019dc:	0f 85 93 fe ff ff    	jne    801875 <work+0xaa>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  8019e2:	e8 5d ef ff ff       	call   800944 <getpid>
  8019e7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8019eb:	c7 04 24 60 20 80 00 	movl   $0x802060,(%esp)
  8019f2:	e8 e6 e9 ff ff       	call   8003dd <cprintf>
    exit(0);
  8019f7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8019fe:	e8 bf ee ff ff       	call   8008c2 <exit>
...
int
main(void) {
  801a03:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801a07:	83 e4 f0             	and    $0xfffffff0,%esp
  801a0a:	ff 71 fc             	pushl  -0x4(%ecx)
  801a0d:	55                   	push   %ebp
  801a0e:	89 e5                	mov    %esp,%ebp
  801a10:	56                   	push   %esi
  801a11:	53                   	push   %ebx
  801a12:	51                   	push   %ecx
  801a13:	83 ec 2c             	sub    $0x2c,%esp
  801a16:	89 e0                	mov    %esp,%eax
  801a18:	89 c3                	mov    %eax,%ebx
    int pids[total];
  801a1a:	b8 15 00 00 00       	mov    $0x15,%eax
  801a1f:	83 e8 01             	sub    $0x1,%eax
  801a22:	89 45 e0             	mov    %eax,-0x20(%ebp)
  801a25:	b8 15 00 00 00       	mov    $0x15,%eax
  801a2a:	c1 e0 02             	shl    $0x2,%eax
  801a2d:	8d 50 03             	lea    0x3(%eax),%edx
  801a30:	b8 10 00 00 00       	mov    $0x10,%eax
  801a35:	83 e8 01             	sub    $0x1,%eax
  801a38:	01 d0                	add    %edx,%eax
  801a3a:	be 10 00 00 00       	mov    $0x10,%esi
  801a3f:	ba 00 00 00 00       	mov    $0x0,%edx
  801a44:	f7 f6                	div    %esi
  801a46:	6b c0 10             	imul   $0x10,%eax,%eax
  801a49:	29 c4                	sub    %eax,%esp
  801a4b:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801a4f:	83 c0 03             	add    $0x3,%eax
  801a52:	c1 e8 02             	shr    $0x2,%eax
  801a55:	c1 e0 02             	shl    $0x2,%eax
  801a58:	89 45 dc             	mov    %eax,-0x24(%ebp)
    memset(pids, 0, sizeof(pids));
  801a5b:	b8 15 00 00 00       	mov    $0x15,%eax
  801a60:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801a67:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801a6a:	89 54 24 08          	mov    %edx,0x8(%esp)
  801a6e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801a75:	00 
  801a76:	89 04 24             	mov    %eax,(%esp)
  801a79:	e8 c4 fb ff ff       	call   801642 <memset>

    int i;
    for (i = 0; i < total; i ++) {
  801a7e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801a85:	eb 70                	jmp    801af7 <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  801a87:	e8 55 ee ff ff       	call   8008e1 <fork>
  801a8c:	8b 55 dc             	mov    -0x24(%ebp),%edx
  801a8f:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  801a92:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  801a95:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801a98:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801a9b:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801a9e:	85 c0                	test   %eax,%eax
  801aa0:	75 42                	jne    801ae4 <main+0xe1>
            srand(i * i);
  801aa2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801aa5:	0f af 45 e4          	imul   -0x1c(%ebp),%eax
  801aa9:	89 04 24             	mov    %eax,(%esp)
  801aac:	e8 23 f8 ff ff       	call   8012d4 <srand>
            int times = (((unsigned int)rand()) % total);
  801ab1:	e8 5e f7 ff ff       	call   801214 <rand>
  801ab6:	ba 15 00 00 00       	mov    $0x15,%edx
  ...
  801acc:	0f af 45 d8          	imul   -0x28(%ebp),%eax
  801ad0:	83 c0 0a             	add    $0xa,%eax
  801ad3:	6b c0 64             	imul   $0x64,%eax,%eax
  801ad6:	89 45 d8             	mov    %eax,-0x28(%ebp)
            work(times);
  801ad9:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801adc:	89 04 24             	mov    %eax,(%esp)
  801adf:	e8 e7 fc ff ff       	call   8017cb <work>
        }
        if (pids[i] < 0) {
  801ae4:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801ae7:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801aea:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801aed:	85 c0                	test   %eax,%eax
  801aef:	79 02                	jns    801af3 <main+0xf0>
            goto failed;
  801af1:	eb 5d                	jmp    801b50 <main+0x14d>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  801af3:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801af7:	b8 15 00 00 00       	mov    $0x15,%eax
  801afc:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801aff:	7c 86                	jl     801a87 <main+0x84>
        if (pids[i] < 0) {
            goto failed;
        }
    }
    ...
    cprintf("fork ok.\n");
  801b01:	c7 04 24 74 20 80 00 	movl   $0x802074,(%esp)
  801b08:	e8 d0 e8 ff ff       	call   8003dd <cprintf>

    for (i = 0; i < total; i ++) {
  801b0d:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801b14:	eb 1b                	jmp    801b31 <main+0x12e>
        if (wait() != 0) {
  801b16:	e8 d3 ed ff ff       	call   8008ee <wait>
  801b1b:	85 c0                	test   %eax,%eax
  801b1d:	74 0e                	je     801b2d <main+0x12a>
            cprintf("wait failed.\n");
  801b1f:	c7 04 24 7e 20 80 00 	movl   $0x80207e,(%esp)
  801b26:	e8 b2 e8 ff ff       	call   8003dd <cprintf>
            goto failed;
  801b2b:	eb 23                	jmp    801b50 <main+0x14d>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  801b2d:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801b31:	b8 15 00 00 00       	mov    $0x15,%eax
  801b36:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b39:	7c db                	jl     801b16 <main+0x113>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
    ...
    cprintf("matrix pass.\n");
  801b3b:	c7 04 24 8c 20 80 00 	movl   $0x80208c,(%esp)
  801b42:	e8 96 e8 ff ff       	call   8003dd <cprintf>
    return 0;
  801b47:	b8 00 00 00 00       	mov    $0x0,%eax
  801b4c:	89 dc                	mov    %ebx,%esp
  801b4e:	eb 51                	jmp    801ba1 <main+0x19e>

failed:
    for (i = 0; i < total; i ++) {
  801b50:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801b57:	eb 22                	jmp    801b7b <main+0x178>
        if (pids[i] > 0) {
  801b59:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b5c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b5f:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801b62:	85 c0                	test   %eax,%eax
  801b64:	7e 11                	jle    801b77 <main+0x174>
            kill(pids[i]);
  801b66:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b69:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b6c:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801b6f:	89 04 24             	mov    %eax,(%esp)
  801b72:	e8 ba ed ff ff       	call   800931 <kill>
...
failed:
    for (i = 0; i < total; i ++) {
  801b77:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801b7b:	b8 15 00 00 00       	mov    $0x15,%eax
  801b80:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b83:	7c d4                	jl     801b59 <main+0x156>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
    panic("FAIL: T.T\n");
  801b85:	c7 44 24 08 9a 20 80 	movl   $0x80209a,0x8(%esp)
  801b8c:	00 
  801b8d:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801b94:	00 
  801b95:	c7 04 24 a5 20 80 00 	movl   $0x8020a5,(%esp)
  801b9c:	e8 4b e7 ff ff       	call   8002ec <__panic>
}
  ...
  801ba6:	5e                   	pop    %esi
  801ba7:	5d                   	pop    %ebp
  801ba8:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801bab:	c3                   	ret    
