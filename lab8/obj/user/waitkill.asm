...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 60 19 80 00 	movl   $0x801960,(%esp)
  ...
  800284:	c7 04 24 6b 19 80 00 	movl   $0x80196b,(%esp)
  ...
  80029a:	c7 04 24 7d 19 80 00 	movl   $0x80197d,(%esp)
  ...
  8002b0:	c7 04 24 90 19 80 00 	movl   $0x801990,(%esp)
  ...
  8002c6:	c7 04 24 a3 19 80 00 	movl   $0x8019a3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 b6 19 80 00 	movl   $0x8019b6,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 d0 19 80 00 	movl   $0x8019d0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 d2 19 80 00 	movl   $0x8019d2,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 d0 19 80 00 	movl   $0x8019d0,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 ee 19 80 00 	movl   $0x8019ee,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 01 1a 80 	movl   $0x801a01,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 22 1a 80 00 	movl   $0x801a22,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 34 1a 80 	movl   $0x801a34,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 3c 1a 80 	movl   $0x801a3c,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 22 1a 80 00 	movl   $0x801a22,(%esp)
  ...
  800ad5:	e8 99 0d 00 00       	call   801873 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 64 1c 80 00       	add    $0x801c64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 88 1c 80 00 	mov    0x801c88(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c 7e 1c 80 	movl   $0x801c7e,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be 81 1c 80 00       	mov    $0x801c81,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8017ce:	83 ec 08             	sub    $0x8,%esp
    yield();
  8017d1:	e8 4e f1 ff ff       	call   800924 <yield>
    yield();
  8017d6:	e8 49 f1 ff ff       	call   800924 <yield>
    yield();
  8017db:	e8 44 f1 ff ff       	call   800924 <yield>
    yield();
  8017e0:	e8 3f f1 ff ff       	call   800924 <yield>
    yield();
  8017e5:	e8 3a f1 ff ff       	call   800924 <yield>
    yield();
  8017ea:	e8 35 f1 ff ff       	call   800924 <yield>
}
  8017ef:	c9                   	leave  
  8017f0:	c3                   	ret    
...
loop(void) {
  ...
  8017f4:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  8017f7:	c7 04 24 e0 1d 80 00 	movl   $0x801de0,(%esp)
  8017fe:	e8 da eb ff ff       	call   8003dd <cprintf>
    while (1);
  801803:	eb fe                	jmp    801803 <loop+0x12>
...
work(void) {
  ...
  801808:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  80180b:	c7 04 24 ea 1d 80 00 	movl   $0x801dea,(%esp)
  801812:	e8 c6 eb ff ff       	call   8003dd <cprintf>
    do_yield();
  801817:	e8 af ff ff ff       	call   8017cb <do_yield>
    if (kill(parent) == 0) {
  80181c:	a1 48 21 80 00       	mov    0x802148,%eax
  801821:	89 04 24             	mov    %eax,(%esp)
  801824:	e8 08 f1 ff ff       	call   800931 <kill>
  801829:	85 c0                	test   %eax,%eax
  80182b:	75 3a                	jne    801867 <work+0x62>
        cprintf("kill parent ok.\n");
  80182d:	c7 04 24 f4 1d 80 00 	movl   $0x801df4,(%esp)
  801834:	e8 a4 eb ff ff       	call   8003dd <cprintf>
        do_yield();
  801839:	e8 8d ff ff ff       	call   8017cb <do_yield>
        if (kill(pid1) == 0) {
  80183e:	a1 50 21 80 00       	mov    0x802150,%eax
  801843:	89 04 24             	mov    %eax,(%esp)
  801846:	e8 e6 f0 ff ff       	call   800931 <kill>
  80184b:	85 c0                	test   %eax,%eax
  80184d:	75 18                	jne    801867 <work+0x62>
            cprintf("kill child1 ok.\n");
  80184f:	c7 04 24 05 1e 80 00 	movl   $0x801e05,(%esp)
  801856:	e8 82 eb ff ff       	call   8003dd <cprintf>
            exit(0);
  80185b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801862:	e8 5b f0 ff ff       	call   8008c2 <exit>
        }
    }
    exit(-1);
  801867:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80186e:	e8 4f f0 ff ff       	call   8008c2 <exit>
...
main(void) {
  ...
  801876:	83 e4 f0             	and    $0xfffffff0,%esp
  801879:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  80187c:	e8 c3 f0 ff ff       	call   800944 <getpid>
  801881:	a3 48 21 80 00       	mov    %eax,0x802148
    if ((pid1 = fork()) == 0) {
  801886:	e8 56 f0 ff ff       	call   8008e1 <fork>
  80188b:	a3 50 21 80 00       	mov    %eax,0x802150
  801890:	a1 50 21 80 00       	mov    0x802150,%eax
  801895:	85 c0                	test   %eax,%eax
  801897:	75 05                	jne    80189e <main+0x2b>
        loop();
  801899:	e8 53 ff ff ff       	call   8017f1 <loop>
    }

    assert(pid1 > 0);
  80189e:	a1 50 21 80 00       	mov    0x802150,%eax
  8018a3:	85 c0                	test   %eax,%eax
  8018a5:	7f 24                	jg     8018cb <main+0x58>
  8018a7:	c7 44 24 0c 16 1e 80 	movl   $0x801e16,0xc(%esp)
  8018ae:	00 
  8018af:	c7 44 24 08 1f 1e 80 	movl   $0x801e1f,0x8(%esp)
  8018b6:	00 
  8018b7:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8018be:	00 
  8018bf:	c7 04 24 34 1e 80 00 	movl   $0x801e34,(%esp)
  8018c6:	e8 21 ea ff ff       	call   8002ec <__panic>

    if ((pid2 = fork()) == 0) {
  8018cb:	e8 11 f0 ff ff       	call   8008e1 <fork>
  8018d0:	a3 4c 21 80 00       	mov    %eax,0x80214c
  8018d5:	a1 4c 21 80 00       	mov    0x80214c,%eax
  8018da:	85 c0                	test   %eax,%eax
  8018dc:	75 05                	jne    8018e3 <main+0x70>
        work();
  8018de:	e8 22 ff ff ff       	call   801805 <work>
    }
    if (pid2 > 0) {
  8018e3:	a1 4c 21 80 00       	mov    0x80214c,%eax
  8018e8:	85 c0                	test   %eax,%eax
  8018ea:	7e 46                	jle    801932 <main+0xbf>
        cprintf("wait child 1.\n");
  8018ec:	c7 04 24 44 1e 80 00 	movl   $0x801e44,(%esp)
  8018f3:	e8 e5 ea ff ff       	call   8003dd <cprintf>
        waitpid(pid1, NULL);
  8018f8:	a1 50 21 80 00       	mov    0x802150,%eax
  8018fd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801904:	00 
  801905:	89 04 24             	mov    %eax,(%esp)
  801908:	e8 fd ef ff ff       	call   80090a <waitpid>
        panic("waitpid %d returns\n", pid1);
  80190d:	a1 50 21 80 00       	mov    0x802150,%eax
  801912:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801916:	c7 44 24 08 53 1e 80 	movl   $0x801e53,0x8(%esp)
  80191d:	00 
  80191e:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  801925:	00 
  801926:	c7 04 24 34 1e 80 00 	movl   $0x801e34,(%esp)
  80192d:	e8 ba e9 ff ff       	call   8002ec <__panic>
    }
    else {
        kill(pid1);
  801932:	a1 50 21 80 00       	mov    0x802150,%eax
  801937:	89 04 24             	mov    %eax,(%esp)
  80193a:	e8 f2 ef ff ff       	call   800931 <kill>
    }
    panic("FAIL: T.T\n");
  80193f:	c7 44 24 08 67 1e 80 	movl   $0x801e67,0x8(%esp)
  801946:	00 
  801947:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  80194e:	00 
  80194f:	c7 04 24 34 1e 80 00 	movl   $0x801e34,(%esp)
  801956:	e8 91 e9 ff ff       	call   8002ec <__panic>
