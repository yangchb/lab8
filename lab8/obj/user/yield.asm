...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 60 18 80 00 	movl   $0x801860,(%esp)
  ...
  800284:	c7 04 24 6b 18 80 00 	movl   $0x80186b,(%esp)
  ...
  80029a:	c7 04 24 7d 18 80 00 	movl   $0x80187d,(%esp)
  ...
  8002b0:	c7 04 24 90 18 80 00 	movl   $0x801890,(%esp)
  ...
  8002c6:	c7 04 24 a3 18 80 00 	movl   $0x8018a3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 b6 18 80 00 	movl   $0x8018b6,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 d0 18 80 00 	movl   $0x8018d0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 d2 18 80 00 	movl   $0x8018d2,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 d0 18 80 00 	movl   $0x8018d0,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 ee 18 80 00 	movl   $0x8018ee,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 01 19 80 	movl   $0x801901,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 08 19 80 	movl   $0x801908,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 34 19 80 	movl   $0x801934,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 3c 19 80 	movl   $0x80193c,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 22 19 80 00 	movl   $0x801922,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 64 1b 80 00       	add    $0x801b64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 88 1b 80 00 	mov    0x801b88(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c 7e 1b 80 	movl   $0x801b7e,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be 81 1b 80 00       	mov    $0x801b81,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017d4:	e8 6b f1 ff ff       	call   800944 <getpid>
  8017d9:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017dd:	c7 04 24 e0 1c 80 00 	movl   $0x801ce0,(%esp)
  8017e4:	e8 f4 eb ff ff       	call   8003dd <cprintf>
    for (i = 0; i < 5; i ++) {
  8017e9:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017f0:	00 
  8017f1:	eb 27                	jmp    80181a <main+0x4f>
        yield();
  8017f3:	e8 2c f1 ff ff       	call   800924 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  8017f8:	e8 47 f1 ff ff       	call   800944 <getpid>
  8017fd:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801801:	89 54 24 08          	mov    %edx,0x8(%esp)
  801805:	89 44 24 04          	mov    %eax,0x4(%esp)
  801809:	c7 04 24 fc 1c 80 00 	movl   $0x801cfc,(%esp)
  801810:	e8 c8 eb ff ff       	call   8003dd <cprintf>
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  801815:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80181a:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  80181f:	7e d2                	jle    8017f3 <main+0x28>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  801821:	e8 1e f1 ff ff       	call   800944 <getpid>
  801826:	89 44 24 04          	mov    %eax,0x4(%esp)
  80182a:	c7 04 24 1f 1d 80 00 	movl   $0x801d1f,(%esp)
  801831:	e8 a7 eb ff ff       	call   8003dd <cprintf>
    cprintf("yield pass.\n");
  801836:	c7 04 24 38 1d 80 00 	movl   $0x801d38,(%esp)
  80183d:	e8 9b eb ff ff       	call   8003dd <cprintf>
    return 0;
