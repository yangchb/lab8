...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 96 19 80 00 	movl   $0x801996,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 b0 19 80 00 	movl   $0x8019b0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 b2 19 80 00 	movl   $0x8019b2,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 b0 19 80 00 	movl   $0x8019b0,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 ce 19 80 00 	movl   $0x8019ce,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 e1 19 80 	movl   $0x8019e1,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 e8 19 80 	movl   $0x8019e8,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 02 1a 80 00 	movl   $0x801a02,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 14 1a 80 	movl   $0x801a14,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 1c 1a 80 	movl   $0x801a1c,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 02 1a 80 00 	movl   $0x801a02,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 44 1c 80 00       	add    $0x801c44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 68 1c 80 00 	mov    0x801c68(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c 5e 1c 80 	movl   $0x801c5e,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be 61 1c 80 00       	mov    $0x801c61,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017d4:	c7 04 24 c0 1d 80 00 	movl   $0x801dc0,(%esp)
  8017db:	e8 fd eb ff ff       	call   8003dd <cprintf>
    if ((pid = fork()) == 0) {
  8017e0:	e8 fc f0 ff ff       	call   8008e1 <fork>
  8017e5:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8017e9:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8017ee:	75 3c                	jne    80182c <main+0x61>
        cprintf("I am the child.\n");
  8017f0:	c7 04 24 e7 1d 80 00 	movl   $0x801de7,(%esp)
  8017f7:	e8 e1 eb ff ff       	call   8003dd <cprintf>
        yield();
  8017fc:	e8 23 f1 ff ff       	call   800924 <yield>
        yield();
  801801:	e8 1e f1 ff ff       	call   800924 <yield>
        yield();
  801806:	e8 19 f1 ff ff       	call   800924 <yield>
        yield();
  80180b:	e8 14 f1 ff ff       	call   800924 <yield>
        yield();
  801810:	e8 0f f1 ff ff       	call   800924 <yield>
        yield();
  801815:	e8 0a f1 ff ff       	call   800924 <yield>
        yield();
  80181a:	e8 05 f1 ff ff       	call   800924 <yield>
        exit(magic);
  80181f:	a1 10 20 80 00       	mov    0x802010,%eax
  801824:	89 04 24             	mov    %eax,(%esp)
  801827:	e8 96 f0 ff ff       	call   8008c2 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  80182c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801830:	89 44 24 04          	mov    %eax,0x4(%esp)
  801834:	c7 04 24 f8 1d 80 00 	movl   $0x801df8,(%esp)
  80183b:	e8 9d eb ff ff       	call   8003dd <cprintf>
    }
    assert(pid > 0);
  801840:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801845:	7f 24                	jg     80186b <main+0xa0>
  801847:	c7 44 24 0c 1a 1e 80 	movl   $0x801e1a,0xc(%esp)
  80184e:	00 
  80184f:	c7 44 24 08 22 1e 80 	movl   $0x801e22,0x8(%esp)
  801856:	00 
  801857:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  80185e:	00 
  80185f:	c7 04 24 37 1e 80 00 	movl   $0x801e37,(%esp)
  801866:	e8 81 ea ff ff       	call   8002ec <__panic>
    cprintf("I am the parent, waiting now..\n");
  80186b:	c7 04 24 44 1e 80 00 	movl   $0x801e44,(%esp)
  801872:	e8 66 eb ff ff       	call   8003dd <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801877:	8d 44 24 18          	lea    0x18(%esp),%eax
  80187b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80187f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801883:	89 04 24             	mov    %eax,(%esp)
  801886:	e8 7f f0 ff ff       	call   80090a <waitpid>
  80188b:	85 c0                	test   %eax,%eax
  80188d:	75 0d                	jne    80189c <main+0xd1>
  80188f:	8b 54 24 18          	mov    0x18(%esp),%edx
  801893:	a1 10 20 80 00       	mov    0x802010,%eax
  801898:	39 c2                	cmp    %eax,%edx
  80189a:	74 24                	je     8018c0 <main+0xf5>
  80189c:	c7 44 24 0c 64 1e 80 	movl   $0x801e64,0xc(%esp)
  8018a3:	00 
  8018a4:	c7 44 24 08 22 1e 80 	movl   $0x801e22,0x8(%esp)
  8018ab:	00 
  8018ac:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  8018b3:	00 
  8018b4:	c7 04 24 37 1e 80 00 	movl   $0x801e37,(%esp)
  8018bb:	e8 2c ea ff ff       	call   8002ec <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8018c0:	8d 44 24 18          	lea    0x18(%esp),%eax
  8018c4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018c8:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018cc:	89 04 24             	mov    %eax,(%esp)
  8018cf:	e8 36 f0 ff ff       	call   80090a <waitpid>
  8018d4:	85 c0                	test   %eax,%eax
  8018d6:	74 09                	je     8018e1 <main+0x116>
  8018d8:	e8 11 f0 ff ff       	call   8008ee <wait>
  8018dd:	85 c0                	test   %eax,%eax
  8018df:	75 24                	jne    801905 <main+0x13a>
  8018e1:	c7 44 24 0c 90 1e 80 	movl   $0x801e90,0xc(%esp)
  8018e8:	00 
  8018e9:	c7 44 24 08 22 1e 80 	movl   $0x801e22,0x8(%esp)
  8018f0:	00 
  8018f1:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8018f8:	00 
  8018f9:	c7 04 24 37 1e 80 00 	movl   $0x801e37,(%esp)
  801900:	e8 e7 e9 ff ff       	call   8002ec <__panic>
    cprintf("waitpid %d ok.\n", pid);
  801905:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801909:	89 44 24 04          	mov    %eax,0x4(%esp)
  80190d:	c7 04 24 b8 1e 80 00 	movl   $0x801eb8,(%esp)
  801914:	e8 c4 ea ff ff       	call   8003dd <cprintf>

    cprintf("exit pass.\n");
  801919:	c7 04 24 c8 1e 80 00 	movl   $0x801ec8,(%esp)
  801920:	e8 b8 ea ff ff       	call   8003dd <cprintf>
    return 0;
