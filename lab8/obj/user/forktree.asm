...
umain(int argc, char *argv[]) {
  ...
  800ad5:	e8 a8 0d 00 00       	call   801882 <main>
...
forkchild(const char *cur, char branch) {
  ...
  8017d4:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  8017d7:	8b 45 08             	mov    0x8(%ebp),%eax
  8017da:	89 04 24             	mov    %eax,(%esp)
  8017dd:	e8 0a fb ff ff       	call   8012ec <strlen>
  8017e2:	83 f8 03             	cmp    $0x3,%eax
  8017e5:	77 4f                	ja     801836 <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  8017e7:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  8017eb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8017ef:	8b 45 08             	mov    0x8(%ebp),%eax
  8017f2:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8017f6:	c7 44 24 08 40 1d 80 	movl   $0x801d40,0x8(%esp)
  8017fd:	00 
  8017fe:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  801805:	00 
  801806:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801809:	89 04 24             	mov    %eax,(%esp)
  80180c:	e8 63 f9 ff ff       	call   801174 <snprintf>
    if (fork() == 0) {
  801811:	e8 cb f0 ff ff       	call   8008e1 <fork>
  801816:	85 c0                	test   %eax,%eax
  801818:	75 1c                	jne    801836 <forkchild+0x6b>
        forktree(nxt);
  80181a:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80181d:	89 04 24             	mov    %eax,(%esp)
  801820:	e8 13 00 00 00       	call   801838 <forktree>
        yield();
  801825:	e8 fa f0 ff ff       	call   800924 <yield>
        exit(0);
  80182a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801831:	e8 8c f0 ff ff       	call   8008c2 <exit>
    }
}
  801836:	c9                   	leave  
  801837:	c3                   	ret    
...
forktree(const char *cur) {
  ...
  80183b:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  80183e:	e8 01 f1 ff ff       	call   800944 <getpid>
  801843:	8b 55 08             	mov    0x8(%ebp),%edx
  801846:	89 54 24 08          	mov    %edx,0x8(%esp)
  80184a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80184e:	c7 04 24 45 1d 80 00 	movl   $0x801d45,(%esp)
  801855:	e8 83 eb ff ff       	call   8003dd <cprintf>

    forkchild(cur, '0');
  80185a:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  801861:	00 
  801862:	8b 45 08             	mov    0x8(%ebp),%eax
  801865:	89 04 24             	mov    %eax,(%esp)
  801868:	e8 5e ff ff ff       	call   8017cb <forkchild>
    forkchild(cur, '1');
  80186d:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  801874:	00 
  801875:	8b 45 08             	mov    0x8(%ebp),%eax
  801878:	89 04 24             	mov    %eax,(%esp)
  80187b:	e8 4b ff ff ff       	call   8017cb <forkchild>
}
  801880:	c9                   	leave  
  801881:	c3                   	ret    
...
main(void) {
  ...
  801885:	83 e4 f0             	and    $0xfffffff0,%esp
  801888:	83 ec 10             	sub    $0x10,%esp
    cprintf("forktree process will sleep %d ticks\n",SLEEP_TIME);
  80188b:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  801892:	00 
  801893:	c7 04 24 58 1d 80 00 	movl   $0x801d58,(%esp)
  80189a:	e8 3e eb ff ff       	call   8003dd <cprintf>
    sleep(SLEEP_TIME);
  80189f:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  8018a6:	e8 c6 f0 ff ff       	call   800971 <sleep>
    forktree("");
  8018ab:	c7 04 24 7e 1d 80 00 	movl   $0x801d7e,(%esp)
  8018b2:	e8 81 ff ff ff       	call   801838 <forktree>
    return 0;
